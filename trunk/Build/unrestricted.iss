...
Source: opcat.properties; DestDir: {app}; Flags: onlyifdoesntexist; Permissions: users-full
...
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\Opcat; Filename: javaw; WorkingDir: {app}; IconFilename: {app}\Opcat2_32x32.ico; IconIndex: 0; Parameters: "-Xmx1024m -jar ""{app}\Opcat2.jar"""

[Dirs]
Name: {app}\backup; Flags: uninsneveruninstall; Attribs: hidden; Permissions: users-full
Name: {app}\models; Flags: uninsneveruninstall; Permissions: users-full
...
Name: {app}\Working Copy; Flags: uninsneveruninstall; Permissions: users-full
