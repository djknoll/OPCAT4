...
public interface IXSystem {
    ...
    /**
     * Returns NAME that holds OPL for OPD given by opdNum
     *
     * @param isHTML - if true NAME returned is HTML formated string, if false
     *               plain text OPL
    ...
    /**
     * Returns NAME that holds OPL for System.
     *
     * @param isHTML - if true NAME returned is HTML formated string, if false
     *               plain text OPL
     ...
     * @param x              - x coordinate for IXProcessInstance
     * @param y              - y coordinate for IXProcessInstance
     * @param parentInstance - an IXThingInstance to add newly created IXProcessInstance
     *                       into.
     * @return newly created IXObjectInstance
     */
     ...
     * @param relationType - Type of relation to create as specified in
     ...
     * @param relationType - Type of link to create as specified in
     *                     exportedAPI.OpcatConstants
     ...
     * @param linkType    - type of possible link as specified in OpcatConstants
     *                    interface.
     * @return IXCheckResult
     ...
     * @param relationType - type of possible relation as specified in OpcatConstants
     *                     interface.
     * @return IXCheckResult
     * @see exportedAPI.OpcatConstants
     */
