...
public interface IXLinkEntry extends IXEntry {
    ...
    /**
     * Returns NAME representing minimum reaction time of this IXLinkEntry.
    ...
    /**
     * Sets minimum reaction time of this IXLinkEntry. This NAME contains
    ...
    /**
     * Returns NAME representing maximum reaction time of this IXLinkEntry.
     * This NAME contains non-negative integer X 7 (msec, sec, min, hours,
     * days, months, years) with semi-colons separation.
     *
    ...
    /**
     * Sets maximum reaction time of this IXLinkEntry. This NAME contains
     * non-negative integer X 7 (msec, sec, min, hours, days, months, years)
