...
public interface IXRelationEntry extends IXEntry {
    ...
    /**
     * Returns NAME representing cardinality of the source IXConnectionEdgeEntry.
     *
     * @return cardinality of the source IXConnectionEdgeEntry as NAME
     */
    ...
    /**
     * Returns NAME representing cardinality of the destination IXConnectionEdgeEntry.
     *
     * @return cardinality of the destination IXConnectionEdgeEntry as NAME
     */
