...
public interface ILinkEntry extends IEntry {
    ...
    /**
     * Returns NAME representing minimum reaction time
     * of this ILinkEntry. This NAME contains non-negative integer X 7
    ...
    /**
     * Returns NAME representing maximum reaction time
     * of this ILinkEntry. This NAME contains non-negative integer X 7
     * (msec, sec, min, hours, days, months, years) with semi-colons
     * separation.
     *
