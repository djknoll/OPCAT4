...
public interface IRelationEntry extends IEntry {
    ...
    /**
     * Returns NAME representing cardinality of the source IConnectionEdgeEntry.
     *
     * @return cardinality of the source IConnectionEdgeEntry as NAME
     */
    public String getSourceCardinality();

    /**
     * Returns NAME representing cardinality of the destination IConnectionEdgeEntry.
     *
     * @return cardinality of the destination IConnectionEdgeEntry as NAME
     */
