...
public class OpcatMessagesConstants {
    ...
    public static enum OPCAT_MESSAGES_OP {
        FILES_COMMIT_MODIFIED,
        FILES_COMMIT_COMPLETED,
        FILES_COMMIT_DELETED,
        FILES_COMMIT_REPLACED,
        FILES_COMMIT_DELTA_SENT,
        FILES_COMMIT_ADDED,
        FILES_UPDATE_NONE,
        FILES_UPDATE_ADD,
        FILES_UPDATE_DELETE,
        FILES_UPDATE_UPDATE_CHANGED,
        FILES_UPDATE_UPDATE_CONFLICTED,
        FILES_UPDATE_UPDATE_MERGED,
        FILES_UPDATE_EXTERNAL,
        FILES_RESTORE,
        ...
        FILES_REVERT,
        NONE,
        EXPOSE_INTERFACE_CHANGE_REQUEST,
        EXPOSE_CHANGE_DONE,
        EXPOSE_CHANGE_REQUEST,
        EXPOSE_UPDATED,
        EXPOSE_ADDED,
        EXPOSE_DELETED,
        EXPOSE_USED,
        EXPOSED_UN_USED,
        EXPOSE_RELEASE_REQUEST,
    }
    ...
    public static enum OPCAT_MESSAGES_SUBSYSTEMS {
        ALL, FILES_COMMIT, FILES_CHECKOUT, MODELS_EXPOSE, MODELS_NOTES
    }
