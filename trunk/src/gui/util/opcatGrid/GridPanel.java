...
import com.sciapp.treetable.GroupingPanel;
...
public class GridPanel extends JPanel {
    ...
    private static boolean removedAllActionPreforemed = false;
    ...
    public static void RemoveALLPanels() {
        ...
        removedAllActionPreforemed = true;
...
//    }
    ...
    public void AddToExtensionToolsPanel(boolean removeFirst) {
        ...
        if (!removedAllActionPreforemed && onExtensionToolsPane) return;
...
class RActionXML extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (Opcat2.getCurrentProject() != null) {
            ...
            myFileChooser.setSelectedFile(new File("export.xml"));
        }
        myFileChooser.resetChoosableFileFilters();
        String[] csv = {"xml"};
        ...
        try {
            ...
            if (ret == JOptionPane.OK_OPTION) {
                ...
                XMLExportManager xmlExporter = new XMLExportManager("/data");
