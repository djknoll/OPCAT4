...
public class GuiControl {
    ...
    public void ShownOPD(Opd opd) {
        getRepository().getOpdTreeView().select(opd);
    }
    ...
    public JToolBar getStandardToolBar() {
        return myOpcat.getStandardToolBar();
    }

    public JToolBarButton getPrintButton() {
        return myOpcat.getPrintButton();
    }
}
