...
public abstract class OpmProceduralLink extends OpmEntity {
    ...
    public static final String DEFAULT_MAX_TIME_REACTION = "infinity";
    public static final String DEFAULT_MIN_TIME_REACTION = new String("0;0;0;0;0;0;0");
     ...
     *
     * @param linkId   OpmProceduralLink id
     * @param linkName OpmProceduralLink name
     */

    public OpmProceduralLink(long linkId, String linkName, long sourceId,
                             long destinationId) {
        super(linkId, linkName);
        this.maxReactionTime = DEFAULT_MAX_TIME_REACTION;
        this.minReactionTime = DEFAULT_MIN_TIME_REACTION;
    ...
    public void copyPropsFrom(OpmEntity origin) {
        ...
        this.maxReactionTime = ((OpmProceduralLink) origin).getMaxReactionTime();
        this.minReactionTime = ((OpmProceduralLink) origin).getMinReactionTime();
        this.condition = ((OpmProceduralLink) origin).getCondition();
        this.path = ((OpmProceduralLink) origin).getPath();
    }
    ...
    /**
     * Returns NAME representing minimum reaction time of this
     * OpmProceduralLink. This NAME contains non-negative integer X 7 (msec,
    ...
    /**
     * Returns NAME representing maximum reaction time of this
     * OpmProceduralLink. This NAME contains non-negative integer X 7 (msec,
     * sec, min, hours, days, months, years) with semi-colons separation.
     */
