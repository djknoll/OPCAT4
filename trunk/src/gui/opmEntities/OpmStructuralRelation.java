...
//---------------------------------------------------------------------------
    ...
    public static final String DEFAULT_SOURCE_CARDINALITY = "1";
    public static final String DEFAULT_DESTINATION_CARDINALITY = "1";
    public static final String DEFAULT_FORWARD_RELATION_MEANING = "";
    public static final String DEFAULT_BACKWARD_RELATION_MEANING = "";
     ...
     *
     * @param relationId       OpmStructuralRelation id
     * @param relationName     OpmStructuralRelation name
    ...
    public OpmStructuralRelation(long relationId, String relationName, OpmConnectionEdge sourceThing, OpmConnectionEdge destinationThing) {
        ...
        this.sourceCardinality = DEFAULT_SOURCE_CARDINALITY;
        this.destinationCardinality = DEFAULT_DESTINATION_CARDINALITY;
        this.forwardRelationMeaning = DEFAULT_FORWARD_RELATION_MEANING;
        this.backwardRelationMeaning = DEFAULT_BACKWARD_RELATION_MEANING;
    ...
    public void copyPropsFrom(OpmEntity origin) {
        ...
        this.sourceCardinality = ((OpmStructuralRelation) origin).getSourceCardinality();
        this.destinationCardinality = ((OpmStructuralRelation) origin).getDestinationCardinality();
        this.forwardRelationMeaning = ((OpmStructuralRelation) origin).getForwardRelationMeaning();
        this.backwardRelationMeaning = ((OpmStructuralRelation) origin).getBackwardRelationMeaning();
    }
...
//	}
    ...
    /**
     * Returns NAME representing cardinality of the source.
     */
    ...
    /**
     * Returns NAME representing cardinality of the destination.
     */
