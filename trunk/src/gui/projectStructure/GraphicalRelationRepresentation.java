...
public class GraphicalRelationRepresentation implements MoveUpdatable {
     ...
     *
     * @param pSource        OpdConnectionEdge which is source for all fundamental
     *                       relation connected via this "triangle".
     * @param pSourceDragger AroundDragger which is connected to the source.
     * @param pLine          OpdLine which connects sourceDragger to the
     *                       "triangle".
     * @param pRelation      OpdFundamentalRelation that represents graphically
     *                       "triangle" itself.
     */
     ...
     * pKey
     *
     * @param pKey OpdKey - key of some FundamentalRelationInstance.
