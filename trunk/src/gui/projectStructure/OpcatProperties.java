...
public class OpcatProperties extends Properties {
    ...
    public final static String maxTimeActivation = "entity.opm.MaxTimeActivation";
    public final static String minTimeActivation = "entity.opm.MinTimeActivation";
    ...
    public void _loadProperties_(Element properties) {
                    ...
                    if (getProperty(res[i]) != null) {
                        try {
                            if (OpcatMCManager.isConnectedToerver()) {
                                File model = OpcatMCManager.getInstance().doExportToTempDir(getProperty(res[i]));
                ...
                if (copy.get(key) != null) {
                    if (withLimit) {
                        ...
                        for (String ig : ignore) {
                            if (ig.equalsIgnoreCase(key.toString())) {
                                doCopy = false;
                                break;
                            }
                        }
