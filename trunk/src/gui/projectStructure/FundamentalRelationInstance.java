...
public class FundamentalRelationInstance extends Instance implements
    ...
    public void setVisible(boolean isVisible) {
        ...
        Enumeration<FundamentalRelationInstance> instances = this.myRepresentation.getInstances();

        boolean visiable = isVisible;
        while (instances.hasMoreElements()) {
            FundamentalRelationInstance ins = instances.nextElement();
            if (!visiable && !(ins.getKey().toString().equalsIgnoreCase(this.getKey().toString())) && ins.isVisible()) {
                visiable = true;
            }
        }
