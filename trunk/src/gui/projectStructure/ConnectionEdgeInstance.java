...
public abstract class ConnectionEdgeInstance extends Instance implements
     ...
     *
     * @param myKey OpdKey - key of graphical instance of some entity.
     */
    ...
    public ThingInstance getParentThingInstance() {
        ...
        if (this.myConnectionEdge == null) return null;
    ...
    protected void copyPropsFrom(ConnectionEdgeInstance origin) {
        ...
        this.setChangedLocation(origin.isChangedLocation());
    }
    ...
    public Enumeration getRelatedInstances() {
        ...
        for (Enumeration e1 = myEntry.getAllRelatedEntities(); e1.hasMoreElements();) {
            ...
            for (Enumeration e2 = relEntry.getInstances(false); e2.hasMoreElements();) {
                ...
                if (relInstance instanceof FundamentalRelationInstance) {
                    ...
                    if (fri.getGraphicalRelationRepresentation().getSource().getOpdKey().equals(this.key) || fri.getDestination().getOpdKey().equals(this.key)) {
