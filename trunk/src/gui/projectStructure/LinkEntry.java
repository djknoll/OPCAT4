...
public class LinkEntry extends Entry implements IXLinkEntry, ILinkEntry {
    ...
    public static final double DEFAULT_RESOURCE_CONSUMPTION = 0;
    public static final boolean DEFAULT_RESOURCE_CONSUMPTION_ACCUMOLATED = false;

    private double resourceConsumption = DEFAULT_RESOURCE_CONSUMPTION;
    private boolean resourceConsumptionAccumolated = DEFAULT_RESOURCE_CONSUMPTION_ACCUMOLATED;
    ...
    public UUID getSourceUUID() {
        return myProject.getSystemStructure().getEntry(getSourceId()).getUUID();
    }

    public UUID getDestinationUUID() {
        return myProject.getSystemStructure().getEntry(getDestinationId()).getUUID();
    }
