...
public class StyledLine implements MoveUpdatable {
    ...
    public void add2Container(Container cn) {
        ...
        for (int i = 0; i < this.lines.size(); i++) {
            ...
            //cn.add((OpdLine) this.lines.get(i), JLayeredPane.PALETTE_LAYER);
        }
    ...
    public void breakLine(OpdLine brLine, Point location) {
        ...
        //cn.add(newLine, JLayeredPane.PALETTE_LAYER);
        locCn.add(newLine, new Integer(JLayeredPane.PALETTE_LAYER.intValue() - 1));
    ...
    private void breakLastLine(Point location) {
        ...
        if (locCn != null) {
            //cn.add(newLine, JLayeredPane.DEFAULT_LAYER);
            locCn.add(newLine, new Integer(
                    JLayeredPane.PALETTE_LAYER.intValue() - 1));
        }
    ...
    public void repaint() {
        ...
        if (points.size() > 1) {
            for (int i = 0; i < points.size(); i++) {
                ((DraggedPoint) points.get(i)).repaintLines();
                //((DraggedPoint) points.get(i)).setLocation(((DraggedPoint) points.get(i)).getX() + 1, ((DraggedPoint) points.get(i)).getY() + 1);
                //((DraggedPoint) points.get(i)).setLocation(((DraggedPoint) points.get(i)).getX() - 1, ((DraggedPoint) points.get(i)).getY() - 1);
            }
        }
