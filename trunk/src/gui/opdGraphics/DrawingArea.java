...
public class DrawingArea extends JDesktopPane implements MouseListener,
    ...
    public DrawingArea(OpdProject pProject, Opd opd) {
        ...
        this.addKeyListener(new OpdKeyListner());

        // selected = new Hashtable();
        // nonselected = new Hashtable();
        // setBorder(BorderFactory.createEtchedBorder());
        setBackground(Configuration.getInstance().getColorFromProperty("graphics.default.OPDBackgroundColor"));
...
class OpdKeyListner implements KeyListener {
