...
public abstract class OpdConnectionEdge extends OpdBaseComponent {
    ...
    public OpmConnectionEdge getEntity() {
        return (OpmConnectionEdge) this.myEntity;
    }
    ...
    public void mousePressed(MouseEvent e) {
        ...
        switch (StateMachine.getCurrentState()) {
            ...
            case StateMachine.ADD_LINK: {
                this.lLine.setVisible(true);
                this.drawLine(e);
                if ((StateMachine.getDesiredComponent() == OpcatConstants.CONSUMPTION_LINK) && (this instanceof OpdProcess)) {
    ...
    private void drawLine(MouseEvent e) {
        ...
        Point sPoint = SwingUtilities.convertPoint(this.getParent(), this.getX(), this.getY(), this.dArea);
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if ((StateMachine.getCurrentState() == StateMachine.USUAL_SELECT) || (StateMachine.getCurrentState() == StateMachine.USUAL_MOVE) || (StateMachine.getCurrentState() == StateMachine.EDIT_CUT)) {
        ...
        if ((currState == StateMachine.ADD_RELATION) || (currState == StateMachine.ADD_GENERAL_RELATION) || (currState == StateMachine.ADD_LINK)) {
            Component tempComp = this.dArea.findComponentAt(SwingUtilities.convertPoint(this, e.getX(), e.getY(), this.dArea));
            ...
            RelativeConnectionPoint sourcePoint = GraphicsUtils.calculateConnectionPoint(this, target);
            RelativeConnectionPoint targetPoint = GraphicsUtils.calculateConnectionPoint(target, this);

            OpdKey sourceKey = new OpdKey(this.getOpdId(), this.getEntityInOpdId());
            OpdKey targetKey = new OpdKey(target.getOpdId(), target.getEntityInOpdId());
            ...
            if (cr.getResult() == IXCheckResult.WRONG) {
                JOptionPane.showMessageDialog(Opcat2.getFrame(), cr.getMessage(), "Opcat2 - Error",
                        JOptionPane.ERROR_MESSAGE);
                StateMachine.reset();
                this.setCursorForState(e);
                this.dArea.repaint();
            ...
            switch (StateMachine.getCurrentState()) {
                ...
                case StateMachine.ADD_RELATION: {
                    try {
                        ...
                        if (this.getParent() == target.getParent()) {
                            ...
                            this.tempContainer = this.myProject.getCurrentOpd().getDrawingArea();
                        }
                        ...
                        FundamentalRelationInstance fr = this.myProject.addFundRelation(this, sourcePoint, target,
                                targetPoint, StateMachine.getDesiredComponent(),
                        ...
                        Selection selection = Opcat2.getCurrentProject().getCurrentOpd().getSelection();
                        ...
                        while (iter.hasNext()) {
                            ...
                            if (obj instanceof Instance) {
                                BaseGraphicComponent comp = (BaseGraphicComponent) ((Instance) obj).getGraphicComponents()[0];
                                if ((comp instanceof OpdObject) || (comp instanceof OpdProcess)) {
                        ...
                        if (goodSelection.size() > 0) {
                            int ret = JOptionPane.showConfirmDialog(Opcat2.getFrame(), "Continue with All selected ?",
                            ...
                            if (ret == JOptionPane.OK_OPTION) {
                                ...
                                while (iter.hasNext()) {
                                    ...
                                    cw = new CommandWrapper(this.getEntity().getId(), sourceKey, newTarget.getEntry().getId(),
                                            newTarget.getKey(), StateMachine.getDesiredComponent(),
                                            this.myProject);
                                    ...
                                    fr = this.myProject.addFundRelation(this,
                                            sourcePoint,
                                            (OpdConnectionEdge) newTarget.getGraphicComponents()[0],
                                            targetPoint, StateMachine.getDesiredComponent(),
                                            this.tempContainer, -1, -1);
                        ...
                        System.out.println("OpdConnectionEdge.java : Exception ADD_RELATION " + e1);
                        e1.printStackTrace();
                    }
                    break;
                }
                ...
                case StateMachine.ADD_GENERAL_RELATION: {
                    try {
                        ...
                        GeneralRelationInstance gr = this.myProject.addGeneralRelation(this, sourcePoint, target,
                ...
                case StateMachine.ADD_LINK: {
                    try {
                        ...
                        if (this.getParent() == target.getParent()) {
                            ...
                            tempContainer = this.myProject.getCurrentOpd().getDrawingArea();
                        }

                        LinkInstance li = this.myProject.addLinks/* addLinkConsistent */(this, sourcePoint,
                        ...
                        if (opds.size() > 0) {
                            ...
                            String s = (String) JOptionPane.showInputDialog(gui.getFrame(), "Adding - ", "Opcat II",
                            ...
                            if (s.equalsIgnoreCase("Step by Step") || s.equalsIgnoreCase("All")) {
                                int n;
                                sourceEnum = li.getSourceInstance().getEntry().getInstances(false);
                                ...
                                while (sourceEnum.hasMoreElements() && !cancel) {
                                    destEnum = li.getDestinationInstance().getEntry().getInstances(false);
                                    locSourceInstance = (Instance) sourceEnum.nextElement();

                                    locSourceConnectionEdge = (OpdConnectionEdge) locSourceInstance.getGraphicComponents()[0];

                                    while (destEnum.hasMoreElements() && !cancel) {
                                        locDestInstance = (Instance) destEnum.nextElement();
                                        locDestConnectionEdge = (OpdConnectionEdge) locDestInstance.getGraphicComponents()[0];
                                        myProject.showOPD(locSourceInstance.getKey().getOpdId(), false);
                                        if (myProject.getCurrentOpd().isContaining(
                                                locSourceInstance) && myProject.getCurrentOpd().isContaining(
                                                locDestInstance) && !myProject.getCurrentOpd().isConnectedByLink(
                                                locSourceInstance,
                                                locDestInstance, li)) {
                                            tempContainer = null;
                                            if (locSourceConnectionEdge.getParent() == locDestConnectionEdge.getParent()) {
                                                tempContainer = locDestConnectionEdge.getParent();
                                            } else {
                                                tempContainer = locDestInstance.getOpd().getDrawingArea();
                                            }
                                            ...
                                            switch (n) {
                                                case JOptionPane.OK_OPTION:
                                                    ...
                                                    cw = new CommandWrapper(
                                                            locSourceConnectionEdge.getEntity().getId(),
                                                            locSourceConnectionEdge.getInstance().getKey(),
                                                            locDestConnectionEdge.getEntity().getId(),
                                                            locDestConnectionEdge.getInstance().getKey(),
                                                            StateMachine.getDesiredComponent(),
                                                            this.myProject);
                                                    ...
                                                    li = myProject.addLinks/* addLinkConsistent */(
                                                            locSourceConnectionEdge,
                                                            new RelativeConnectionPoint(
                                                                    locSourceConnectionEdge.getX(),
                                                                    locSourceConnectionEdge.getY()),
                                                            locDestConnectionEdge,
                                                            new RelativeConnectionPoint(
                                                                    locDestConnectionEdge.getX(),
                                                                    locDestConnectionEdge.getY()),
                                                            tempContainer,
                                                            StateMachine.getDesiredComponent(),
                                                            -1, -1);
                                            ...
                                            myProject.showOPD(opd.getOpdId(), false);
                                        }
                                    }
                                }
                            }
    ...
    private ArrayList getConsistencyAddingOPDs(LinkInstance li) {
        ...
        while (opdEnum.hasMoreElements() && !linkExists) {
            ...
            if (link.getKey().getEntityInOpdId() == li.getKey().getEntityInOpdId()) {
                linkExists = true;
                break;
            }
        }
        ...
        Enumeration sourceEnum = li.getSourceInstance().getEntry().getInstances(false);
        Enumeration destEnum;
        while (sourceEnum.hasMoreElements()) {
            ...
            while (destEnum.hasMoreElements()) {
                ...
                if ((destID != OpdProject.CLIPBOARD_ID) && (sourceID != OpdProject.CLIPBOARD_ID)) {
                    locFound = !(addedDest.toString().equalsIgnoreCase(locDestInstance.getKey().toString()));

                    locFound = locFound && !(addedSource.toString().equalsIgnoreCase(locSourceInstance.getKey().toString()));
                    locFound = locFound && (destID == sourceID) && (destID != myProject.getCurrentOpd().getOpdId());
    ...
    public void drawSelection(Graphics2D g) {
        ...
        g.fillRect(0, this.getActualHeight() - 1 - dSelOffset, dSelOffset,
                dSelOffset);
        g.fillRect(this.getActualWidth() / 2 - selOffset, this.getActualHeight() - 1 - dSelOffset, dSelOffset, dSelOffset);
        g.fillRect(this.getActualWidth() - 1 - dSelOffset, this.getActualHeight() - 1 - dSelOffset, dSelOffset, dSelOffset);
        g.fillRect(this.getActualWidth() - 1 - dSelOffset, this.getActualHeight() / 2 - selOffset, dSelOffset, dSelOffset);
        ...
        g.drawRect(0, this.getActualHeight() - 1 - dSelOffset, dSelOffset,
                dSelOffset);
        g.drawRect(this.getActualWidth() / 2 - selOffset, this.getActualHeight() - 1 - dSelOffset, dSelOffset, dSelOffset);
        g.drawRect(this.getActualWidth() - 1 - dSelOffset, this.getActualHeight() - 1 - dSelOffset, dSelOffset, dSelOffset);
        g.drawRect(this.getActualWidth() - 1 - dSelOffset, this.getActualHeight() / 2 - selOffset, dSelOffset, dSelOffset);
    ...
    private void addProcess(int x, int y) {
        ...
        OpdProcess sampleProcOpd = (OpdProcess) sampleProcInstance.getConnectionEdge();
        ...
        if (pd.showDialog()) {
            ...
            OpmProcess newProcess = (OpmProcess) pi.getEntry().getLogicalEntity();
    ...
    public synchronized void pauseAnimaition() {
        ...
        this.performedTime = (new GregorianCalendar()).getTime().getTime() - this.startTime;
    }
    ...
    public synchronized void continueAnimaition() {
        ...
        this.startTime = (new GregorianCalendar()).getTime().getTime() - this.performedTime;
    ...
    public synchronized void animateUrl(long time) {
        ...
        String url = myEntry.getUserURL().toLowerCase();
        if (url != null) {
            if (!url.equalsIgnoreCase("none") && (url.endsWith("jpg") || url.endsWith("bmp") || url.endsWith("gif") || url.endsWith("jpeg") || url.endsWith("mpa") || url.endsWith("avi") || url.endsWith("qt") || url.endsWith("mp4") || url.endsWith("mp3") || url.endsWith("mpg") || url.endsWith("mpeg") || url.endsWith("wmv") || url.endsWith("wma") || url.endsWith("amr"))) {
                try {
                    BrowserLauncher2.openURL(myEntry.getUserURL());
                } catch (Exception e) {
                    OpcatLogger.error(e);
                }
            }
    ...
    public synchronized long getRemainedTestingTime() {
        ...
        return this.totalTime + this.startTime - (new GregorianCalendar()).getTime().getTime();
    }
    ...
    Action change2testingColor = new AbstractAction() {
        ...
        public synchronized void actionPerformed(java.awt.event.ActionEvent e) {
            ...
            long timeLeft = OpdConnectionEdge.this.totalTime + OpdConnectionEdge.this.startTime - (new GregorianCalendar()).getTime().getTime();
            ;

            if (timeLeft <= 0) {
                OpdConnectionEdge.this.stopColorChangeImmediately(OpdConnectionEdge.this.testingColor);
                OpdConnectionEdge.this.animatedUp = false;
                return;
            }

            double param = 1.0 - (double) (timeLeft) / (double) (OpdConnectionEdge.this.totalTime);
            OpdConnectionEdge.this.setBackgroundColor(new Color(
                    OpdConnectionEdge.this.originalColor.getRed() + (int) ((OpdConnectionEdge.this.testingColor.getRed() - OpdConnectionEdge.this.originalColor.getRed()) * param),
                    OpdConnectionEdge.this.originalColor.getGreen() + (int) ((OpdConnectionEdge.this.testingColor.getGreen() - OpdConnectionEdge.this.originalColor.getGreen()) * param),
                    OpdConnectionEdge.this.originalColor.getBlue() + (int) ((OpdConnectionEdge.this.testingColor.getBlue() - OpdConnectionEdge.this.originalColor.getBlue()) * param)));
    ...
    Action change2originalColor = new AbstractAction() {
        ...
        public synchronized void actionPerformed(java.awt.event.ActionEvent e) {
            ...
            if (timeLeft <= 0) {
                OpdConnectionEdge.this.stopColorChangeImmediately(OpdConnectionEdge.this.originalColor);
                ...
                if (edge instanceof OpdObject) {
                    ...
                    opdObject.getEntry().getInstances(false).nextElement();
            ...
            double param = 1.0 - (double) (timeLeft) / (double) (OpdConnectionEdge.this.totalTime);
            OpdConnectionEdge.this.setBackgroundColor(new Color(
                    OpdConnectionEdge.this.testingColor.getRed() + (int) ((OpdConnectionEdge.this.originalColor.getRed() - OpdConnectionEdge.this.testingColor.getRed()) * param),
                    OpdConnectionEdge.this.testingColor.getGreen() + (int) ((OpdConnectionEdge.this.originalColor.getGreen() - OpdConnectionEdge.this.testingColor.getGreen()) * param),
                    OpdConnectionEdge.this.testingColor.getBlue() + (int) ((OpdConnectionEdge.this.originalColor.getBlue() - OpdConnectionEdge.this.testingColor.getBlue()) * param)));
            OpdConnectionEdge.this.repaint();
    ...
    private Color muchBrighter(Color origColor) {
        ...
        return new Color(r + (255 - r) / 2, g + (255 - g) / 2, b + (255 - b) / 2);
    }
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        if (this.getEntry().hasTextRepresentation())
            toolTip = (Configuration.getInstance().getProperty("graphics.default.tooltip.header").trim().equalsIgnoreCase("") ? "" : " <h4>" + Configuration.getInstance().getProperty("graphics.default.tooltip.header") + "</h4>") + this.getEntry().getTextRepresentation().replace("\n", "<br>");

        if (this.myEntry.hasURL()) {
            toolTip = toolTip + "  <p><h4>URL</h4>Press Ctrl+Left-Mouse to activate URL : <br> <ul><u>" + this.myEntry.getURL() + " </u></ul> </p> ";
        }
        ...
        if (toolTip != null) {
            ...
            this.setBorderColor((Color) this.myProject.getConfiguration().getProperty("UrlColor"));
