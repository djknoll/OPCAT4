...
public class OpdProcess extends OpdThing {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (Configuration.getInstance().getProperty("show_times_on_process") != null) {
            String str = Configuration.getInstance().getProperty(
                    "show_times_on_process");
            if (str.equalsIgnoreCase("yes") && (myEntity instanceof OpmProcess))
                this._drawTimes(g2);
        }
    ...
    /**
     * @param pPoint < -- The relation of connection point to length of
     *               the given side
    ...
    public void setLocation(int x, int y) {
        ...
        if (getInstance() != null)
            ((ProcessInstance) getInstance()).reCalculateOrder();
    }
    ...
    private void _drawTimes(Graphics2D g2) {
        OpmProcess p = (OpmProcess) myEntity;
