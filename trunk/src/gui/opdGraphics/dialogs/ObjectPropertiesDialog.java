...
public class ObjectPropertiesDialog extends JDialog implements OpcatDialog,
    ...
    private JTextArea name, description, url, notes, iconPath,
            generaldescription /*
								 * , type
								 */;
    ...
    private JScrollPane /* typeScrollPane, */
            generaldescriptionScrollPane, notesScrollPane, nameScrollPane, urlScrollPane,
            iconScrollPane;
     ...
     * Constructor:
     *
     * @param pObject -- the OPD object to show
    ...
    private void _initVariables() {
        try {
            if ((this.showTabs & BaseGraphicComponent.SHOW_1) != 0) {
                ...
                if (this.myEntry.getUserURL().trim().equals("")) {
                    this.url = new JTextArea(this.defaultUrl, 1, 24);
                } else {
                    this.url = new JTextArea(this.myEntry.getUserURL(), 1, 24);
                }
                ...
                // type = new JTextArea(object.getIDType(), 3, 30);
            ...
            if ((this.showTabs & BaseGraphicComponent.SHOW_2) != 0) {
                ...
                /*
                     ...
                     * intended. raanan
                     */
                this.description = new JTextArea(this.myEntry.getDescription(),
                        8, 30);
                ...
                // description
                this.generaldescription = new JTextArea(this.myEntry
                        .getDescription(), 9, 30);
                ...
                this.notes = new JTextArea(this.myEntry
                        .getProperty("entry.general.notes"), 10, 30);
    ...
    private JPanel _constructDescriptionTab() {
        ...
        this.p1.add(Box.createVerticalStrut(5));
    ...
    private boolean _updateObjectData() {
        ...
        if ((this.showTabs & BaseGraphicComponent.SHOW_1) != 0) {
            ...
            if (!this.object.equals(this.url.getText())) {
                this.myEntry.setUserURL(this.url.getText().trim());
            }

            this.myEntry.setIcon(this.iconPath.getText().trim());

            if (!this.object.equals(this.generaldescription.getText())) {
                this.myEntry.setDescription(this.generaldescription.getText()
                        .trim());
            }

            this.myEntry.setProperty("entry.general.notes", this.notes.getText().trim());
