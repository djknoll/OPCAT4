...
public class LinkPropertiesDialog extends JDialog implements OpcatDialog,
    ...
    private JTextArea description, condition, iconPath, url;

    private JScrollPane descriptionScrollPane, conditionScrollPane,
            iconScrollPane, urlScrollPane;
    ...
    private JButton bgColor, textColor, borderColor, iconButton, resourceButton;
    ...
    private boolean _updateLinkData() {
        ...
        if ((resourceConsumption != null)
            ...
            if ((myEntry.getLinkType() == OpcatConstants.EFFECT_LINK)
                ...
                ((LinkInstance) this.myInstance).setColorByResource();
        ...
        if (!this.opmLink.equals(this.url.getText())) {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (newRef != null) {
                ...
                if (type == DataCreatorType.REFERENCE_TYPE_TEMPLATE_POLICY_FILE) {
                    LinkPropertiesDialog.this.url.setText("file:///"
                            .concat(path));
                } else {
                    LinkPropertiesDialog.this.url.setText(path);
                }
            }
            return;
        }
