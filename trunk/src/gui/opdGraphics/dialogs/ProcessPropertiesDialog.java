...
public class ProcessPropertiesDialog extends JDialog implements OpcatDialog,
    ...
    private JTextArea description, body, notes;
    ...
    private JScrollPane bodyScrollPane, descriptionScrollPane, nameScrollPane,
            urlScrollPane, iconScrollPane, notesScrollPane;
     ...
     * Constructor:
     *
     * @param pProcess -- the OPD object to show
    ...
    private void _initVariables() {
        try {
            ...
            if ((this.showTabs & BaseGraphicComponent.SHOW_1) != 0) {
                ...
                if (myEntry.getUserURL().trim().equals("")) {
                    this.url = new JTextArea(this.defaultUrl, 1, 24);
                } else {
                    this.url = new JTextArea(myEntry.getUserURL(), 1, 24);
                }
            ...
            // desc & body
            if ((this.showTabs & BaseGraphicComponent.SHOW_2) != 0) {
                if (valueOf(Configuration.getInstance().getProperty("process.body.aggragate"))) {
                    this.body = new JTextArea(myEntry.getAggragatedProperty((ThingInstance) opdProcess.getInstance(), Configuration.getInstance().getProperty("process.body.aggragate.key")), 10, 30);
                ...
                this.description = new JTextArea(myEntry.getDescription(),
                        4, 30);

                //this.description = new JEditorPane("text/html", myEntry.getPropertiesHTML(null));
                ...
                this.notes = new JTextArea(myEntry.getProperty("entry.general.notes"), 4, 30);
                ...
                this.url = new JTextArea(myEntry.getUserURL(), 1, 8);
                this.urlScrollPane = new JScrollPane(this.url,
                        ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
                        ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
                this.url.setLineWrap(true);
    ...
    private JPanel _constructPreferences1Tab() {
        ...
        this.p1 = new JPanel();
        this.p1.setBorder(BorderFactory.createTitledBorder(BorderFactory
                .createEtchedBorder(), " Notes "));
        p1.setLayout(new BoxLayout(p1, BoxLayout.X_AXIS));
        this.p1.add(this.notesScrollPane);
        tab.add(this.p1);
        ...
        this.p1.add(new Box.Filler(new Dimension(3, 3), new Dimension(3, 3), new Dimension(3, 3)));
    ...
    private boolean _updateProcessData() {
        ...
        if ((this.showTabs & BaseGraphicComponent.SHOW_1) != 0) {
            ...
            this.myEntry.setName(this.name.getText().trim());
            myEntry.setUserURL(this.url.getText().trim());
        ...
        // description & body
        if ((this.showTabs & BaseGraphicComponent.SHOW_2) != 0) {
            myEntry.setDescription(this.description.getText());
            if (!valueOf(Configuration.getInstance().getProperty("process.body.aggragate"))) {
                this.process.setProcessBody(this.body.getText());
            }
            myEntry.setProperty("entry.general.notes", this.notes.getText().trim());
        }
    ...
    public void commitLockForEdit() {
        ...
        this.notesScrollPane.setEnabled(false);
    ...
    class resourceListner implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (newRef != null) {
                ...
                if (type == DataCreatorType.REFERENCE_TYPE_TEMPLATE_POLICY_FILE) {
