...
public abstract class OpdLink extends AroundDragger {
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        Entry myEntry = myProject.getSystemStructure().getEntry(myLink.getId());
        if ((myEntry != null) && myEntry.hasURL()) {
            this.beforeEventBorderColor = this.getBorderColor();
            this.beforeEventBAckgroundColor = this.getBackgroundColor();
            ...
            this.setBackgroundColor((Color) this.myProject.getConfiguration().getProperty("UrlColor"));
    ...
    public void mouseExited(MouseEvent e) {
        ...
        if (this.colorChanged) {
            ...
            this.setBackgroundColor(this.beforeEventBAckgroundColor);
