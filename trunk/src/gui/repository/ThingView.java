...
public class ThingView extends BaseView implements DragSourceListener,
    ...
    class CDropTargetListener implements DropTargetListener {
        ...
        public void drop(DropTargetDropEvent e) {
            ...
            if ((obj instanceof OpmThing)
                ...
                ThingView.this.results.AddToExtensionToolsPanel(true);
    ...
    class MyCellRenderer extends DefaultTreeCellRenderer {
        ...
        public Component getTreeCellRendererComponent(JTree tree, Object value,
            ...
            if ((nodevalue instanceof OpmThing) && (((ThingEntry) myProject.getSystemStructure().getEntry(((OpmThing) nodevalue).getId())).getIcon() != null)) {
                ImageIcon icon = new ImageIcon(((ThingEntry) myProject.getSystemStructure().getEntry(((OpmThing) nodevalue).getId())).getIconPath());
                opdRenderer.setClosedIcon(icon);
                opdRenderer.setOpenIcon(icon);
                opdRenderer.setIcon(icon);
            } else {
                opdRenderer.setClosedIcon(closed);
                opdRenderer.setOpenIcon(openIcon);
                opdRenderer.setIcon(normal);
            }
