...
public abstract class BaseView extends JTree {
    ...
    public BaseView(String invisibleRoot) {
        ...
        TreeSearchable searchTree = SearchableUtils.installSearchable(this);
        searchTree.setRecursive(true);        // getSelectionModel().setSelectionMode(TreeSelectionModel.SINGLE_TREE_SELECTION);
