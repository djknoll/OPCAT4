...
public class RDirPopup extends RDefaultPopup {
        ...
        if (userObject instanceof OpcatFile) {
            ...
            if (file.isWorkinCopyFile()) {
                ...
                if (!readonlyModelsdir && online) {
                    ...
                    item = add(new SVNAddToGroupAction(file, "Groups", null));
                    item.setToolTipText("Add all to group");
                ...
                if (!readonlyModelsdir) {
                    ...
                    if (OpcatMCManager.isOnline()
                        ...
                        //}
                        add(new JSeparator());
                        item = add(new SvnVersionsGridAction("model Diff", file, SvnImages.ACTION_REVISION_EDITOR));
                        item
                                .setToolTipText("OPCAT Models Diff");
                    }
                }
    ...
    Action AddasClassification = new AbstractAction("Add as Classification",
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            int type = DataCreatorType.REFERENCE_TYPE_PRIVATE_CLASSIFICATION_FILE;
            try {
                if (myProject != null) {
