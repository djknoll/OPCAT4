...
public class CompleteRelationsForConnectionEdgeEntry extends EditAction {
    ...
    public CompleteRelationsForConnectionEdgeEntry(String name, Icon icon,
                                                   ConnectionEdgeInstance instance, boolean addMissingThings, int relationType) {
        super(name, icon);
    ...
    private void completeLinks(boolean isSource, ConnectionEdgeInstance instance) {
        ...
        myEntry.completeRealtions(opd, isSource, addMissingThings, instance, relationType);
