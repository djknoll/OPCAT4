 ...
 * NAME path = (NAME)newRef.get("path");<br>
...
public class LibraryLocationDialog extends JDialog {
     ...
     */
    private int libraryResourceType = DataCreatorType.REFERENCE_TYPE_TEMPLATE_POLICY_FILE;
     ...
     *
     * @param _location     NAME The meta-library path.
    ...
    private void jbInit() throws Exception {
        ...
        if (this.libraryResourceType == DataCreatorType.REFERENCE_TYPE_TEMPLATE_POLICY_FILE) {
            this.changeToFile();
        } else {
            this.changeToURL();
        }
    ...
    private void changeToFile() {
        ...
        this.libraryResourceType = DataCreatorType.REFERENCE_TYPE_TEMPLATE_POLICY_FILE;
    }
