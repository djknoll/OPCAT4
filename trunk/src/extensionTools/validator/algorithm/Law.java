...
public class Law extends Constraint {
    ...
    public static final int MAX_COUNTS = 10000;
...
//	private NAME genereteHashKey(VRole vrole, Applicant applicant)	{
//		ModelVRole mvrole = (ModelVRole)vrole;
//		NAME key = mvrole.getOriginalThing().getId() +":"+ vrole.getThingID() +":"+ applicant.getRole().getThingID();
//		return key;		
//	}
