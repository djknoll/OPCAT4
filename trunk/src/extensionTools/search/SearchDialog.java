...
public class SearchDialog {
    ...
    private static JCheckBox jCheckBoxinParams = null;
    ...
    public static void dispose() {
        try {
            ...
            if (jDialog != null) jDialog.setVisible(false);
            if (instance != null) instance.setVisible(false);
            if (jDialog != null) jDialog.removeAll();
            if (jDialog != null) jDialog.dispose();

            instance = null;
            jDialog = null;
            jPanel = null;
            jCheckBoxforObjects = null;
            jCheckBoxforStates = null;
            jCheckBoxforProcesses = null;
            jPanel1 = null;
            jCheckBoxinName = null;
            jCheckBoxinDescription = null;
            jCheckBoxinParams = null;
            jPanel2 = null;
            jPanel3 = null;
            jTextArea = null;
            jPanel4 = null;
    ...
    public static JDialog getInstance(IXSystem system) {
        if (instance == null) {
            instance = getJDialog();
            instance.setLocationRelativeTo(system.getMainFrame());
    ...
    private static JPanel getJPanel1() {
        if (jPanel1 == null) {
            ...
            jPanel1.add(getJCheckBoxinParams(), null);
        }
        return jPanel1;
    }
    ...
    private static JCheckBox getJCheckBoxinParams() {
        if (jCheckBoxinParams == null) {
            jCheckBoxinParams = new JCheckBox();
            jCheckBoxinParams.setText("Parameters");
        }
        return jCheckBoxinParams;
    }
    ...
    private static JTextArea getJTextArea() {
        if (jTextArea == null) {
            ...
            //jTextArea.setText("Enter Search NAME Here");
    ...
    private static void fillBaseOptions(OptionsBase options) {
        ...
        options.inParams = getJCheckBoxinParams().isSelected();
