...
public class ClassDiagram {
     ...
     *
     * @param sys
     * @param tagsVec              - responsible for outside printing of the part
     *                             TaggedValue in XML
     * @param classDiagramElements - responsible for outside printing of
     *                             classes in XML
     * @param specVec              - responsible for outside printing in XML
     * @param assEndVec            - responsible for outside printing of assosiationEnd
     *                             in class diagram
     * @param assVec               - responsible for outside printing of assosiations in
     *                             class diagram
     */
            ...
            while (e.hasMoreElements()) {
                ...
                if (abstractEntry instanceof IObjectEntry) {
                    ...
                    if ((!obj.isPhysical()) && (!obj.isEnvironmental())
                        ...
                        inst_list = obj.getInstances(false);
    ...
    private void generateClass(IObjectEntry obj, Vector<String> specVec,
        ...
        try {
            if ((!obj.isPhysical()) && (!obj.isEnvironmental())
                ...
                IObjectInstance instance = (IObjectInstance) obj.getInstances(false)
                        .nextElement();
     ...
     *
     * @param MyStructure
     * @param ent-it      can be an IStateEntry or an IObjectEntry only.
    ...
    private String getParentThing(IObjectEntry obj) {
        ...
        locenum = obj.getInstances(false);
