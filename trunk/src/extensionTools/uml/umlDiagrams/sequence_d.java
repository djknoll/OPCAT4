...
public class sequence_d {
    ...
    /**
     * Checks if the given NAME is already in the given Vector
     *
     * @param String path
     * @param Vector vec
    ...
    private boolean isBasic(IProcessEntry proc) {
        ...
        locenum = proc.getInstances(false);
        while (locenum.hasMoreElements()) {
     ...
     * @param Vector           vecProc - contains all found procs that need to appear in the
     *                         list.
     */
     ...
     * from down to top.
     *
     * @param IProcessEntry topProc - the "hiest" process, can not go over it (the process
     ...
     * @param Vector        ClassifierRolePrint - for outside printing of Classifaer Role
     *                      part in xml file.
     */
     ...
     * @param Vector notSeqEntryVec - all objects needs to be a Classifaer Role and
     ...
     *
     * @param Vector notSeqEntryVec - all clasifiers roles that has no transitions
     ...
     * @param Vector           ClassifierRolePrint - will contains all classifier roles for
     *                         outside printing
     * @param Vector           AssociationPrint - will contains all association roles for
     *                         outside printing
     */
