...
public class ReuseCommand {
     ...
     *
     * @param _current   the current system that the reused model will be
     *                   imported into it
     * @param _reusedLib the reused system - the external model that will be
     ...
     *
     * @param reusedOpd      The OPD that the elements are copied from
     * @param targetOpd      The OPD that the elements are copied to
     * @param container      The instance that the elements will be placed within
     *                       it. If it is null, then the elements will not be
     *                       contained within an inzommed entity.
     * @param forceContainer A flag indicating whether a container which is not
            ...
            while (e.hasMoreElements()) {
                ...
                if ((generalInstance instanceof ObjectInstance)
                    ...
                    if (generalInstance instanceof ObjectInstance) {
                        ...
                        // or a
                        // process
                        OpcatLogger.error("instance wrong in reuse - "
                                + generalInstance);
                    }
     ...
     *
     * @param reusedObjectInstance
     * @param x                    The x coordinate of the new thing
     * @param y                    The y coordinate of the new thing
     * @param targetOpd            The opd in which the thing is added
     * @param container            The container object of the thing. Can be null, if the
     ...
     * @param x                     The x coordinate of the new thing
     * @param y                     The y coordinate of the new thing
     * @param current_opd           The opd in which the thing is added
     * @param container             The container object of the thing. Can be null, if the
     *                              thing is not added under a container
     * @return The new instance, or null if the thing was not added
     */
     ...
     * instance.
     *
     * @param reusedInstance The original instance in the reused model
     * @param addedInstance  The instance that was added to the base model
     * @param target         The OPD in which the addedInstance was added to
     */
    ...
    protected void copyReusedEntryProperties(Entry reusedEntry,
        ...
        targetEntry.setUserURL(reusedEntry.getUserURL());
    ...
    protected void copyReusedThingEntryProperties(ThingEntry reusedThingEntry,
        ...
        targetThingEntry.setUserURL(reusedThingEntry.getUserURL());
    ...
    protected void copyReusedProcessEntryProperties(ProcessEntry reused,
        ...
        target.setUserURL(reused.getUserURL());
    ...
    protected void copyReusedObjectEntryProperties(
        ...
        targetObjectEntry.setUserURL(reusedObjectEntry.getUserURL());
