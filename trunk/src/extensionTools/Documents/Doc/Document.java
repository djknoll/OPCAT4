...
public class Document {
     ...
     *
     * @param t    of type NAME to be printed
     * @param file of type FileOutputStream
     * @throws IOException
     */

    void printActTime(String t, OutputStreamWriter file) throws IOException {
        String temp;
        try {
            // cut the string by ';'
     ...
     * @param filename of type NAME
     * @throws IOException
     */

    public void PrintOpd(IOpd opd, OutputStreamWriter f, String filename) {
        try {
            ...
            opdfile = "_" + cleanName(opd.getName()) + "_" + temp_long + "_OPD.jpeg";
            oplfile = "_" + cleanName(opd.getName()) + "_" + temp_long + "_OPL.html";
            ...
            boolean created = aFile.createNewFile(); // Now create a new file if necessary
            created = oFile.createNewFile();

            FileOutputStream fos = new FileOutputStream(aFile);
            //FileWriter opl_os = new FileWriter(oFile);
            OutputStreamWriter opl_os = new OutputStreamWriter(new FileOutputStream(oFile), "UTF-8");
     ...
     *
     * @param name of type NAME. The name of the diagram.
    ...
    public void PrintDocument(ISystem sys, String filename) throws IOException {
        ...
        try {
            ...
            OutputStreamWriter file = new OutputStreamWriter(new FileOutputStream(new File(filename)), "UTF-8");
            IEntry abstractEntry;
            IObjectEntry obj;
            IStateEntry state;
            IProcessEntry proc;
            ...
            String temp = "1";
            Enumeration total_e;
            Vector<IObjectEntry> obj_v = new Vector<IObjectEntry>(0, 1);
            Vector<IProcessEntry> proc_v = new Vector<IProcessEntry>(0, 1);
            Vector<ILinkEntry> link_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> agent_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> cond_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> cons_ev_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> cons_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> effect_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> exception_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> instr_ev_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> instr_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> invoc_l_v = new Vector<ILinkEntry>(0, 1);
            Vector<ILinkEntry> res_l_v = new Vector<ILinkEntry>(0, 1);

            Vector<IRelationEntry> rel_v = new Vector<IRelationEntry>(0, 1);
            Vector<IRelationEntry> aggr_r_v = new Vector<IRelationEntry>(0, 1);
            Vector<IRelationEntry> feat_r_v = new Vector<IRelationEntry>(0, 1);
            Vector<IRelationEntry> gen_r_v = new Vector<IRelationEntry>(0, 1);
            Vector<IRelationEntry> class_r_v = new Vector<IRelationEntry>(0, 1);
            Vector<IRelationEntry> uni_r_v = new Vector<IRelationEntry>(0, 1);
            Vector<IRelationEntry> bi_r_v = new Vector<IRelationEntry>(0, 1);
                ...
                if ((this.DocInfo.opdopl.getOPLAccording())
                    ...
                    if (this.DocInfo.opdopl.getOPDAll()) {
                        ...
                        while (size < arr.length) {
                            opd = arr[size];
                            opl = this.mySys.getOPL(true, opd.getOpdId());
                ...
                if (((this.DocInfo.Data.Obj.isSelected()) || (this.DocInfo.Data.Proc
                    ...
                    if (this.DocInfo.Data.Obj.isSelected() && (!obj_v.isEmpty())) {
                        ...
                        while (i < arr.length) {
                            ...
                            file.write(temp);
                            Enumeration objEnum = obj.getInstances(false);
                    ...
                    if ((this.DocInfo.Data.Proc.isSelected()) && (!proc_v.isEmpty())) {
                        ...
                        while (i < arr_p.length) {
                            ...
                            Enumeration procEnum = proc.getInstances(false);
     ...
     * @throws IOException
     */
    public void FromTemp(FileInputStream inFile) {
        try {
