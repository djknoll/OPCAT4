...
public abstract class OpdConnectionEdge extends OpdBaseComponent {
            ...
            switch (StateMachine.getCurrentState()) {
                ...
                case StateMachine.ADD_RELATION: {
                    try {
                        ...
                        FundamentalRelationInstance fr = this.myProject.addRelation(this, sourcePoint, target,
                ...
                case StateMachine.ADD_LINK: {
                    try {
                            ...
                            if (s.equalsIgnoreCase("Step by Step") || s.equalsIgnoreCase("All")) {
                                ...
                                while (sourceEnum.hasMoreElements() && !cancel) {
                                    ...
                                    while (destEnum.hasMoreElements() && !cancel) {
                                        ...
                                        myProject.showOPD(locSourceInstance.getKey().getOpdId());
                                        if (myProject.getCurrentOpd().isContaining(
                                                locSourceInstance) && myProject.getCurrentOpd().isContaining(
                                                locDestInstance) && !myProject.getCurrentOpd().isConnected(
                                                locSourceInstance,
                                                locDestInstance, li)) {
                                            tempContainer = null;
                        ...
                        System.out.println("Exception ADD_LINK at OpdConnection edge " + e1);
                        e1.printStackTrace();
                    }
                    break;
                }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        //     if(c instanceof OpdThing) {
        //         this.setLocation(c.getWidth()/2 , this.getY());
        //     }
        // }
    }
