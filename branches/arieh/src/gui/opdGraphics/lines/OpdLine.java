...
public abstract class OpdLine extends JComponent implements MouseListener,
     ...
     * @param pSide1  int</code>, the border of first edge as defined in <a
     *                href = "OpdBaseComponent.html"><code>OpdBaseComponent</code></a>.
     * @param pParam1 double</code>, connection parameter for positioning
     *                the connection point on the component's border.
     * @param pEdge2  Connectable</code>, second edge of Opd Link a
     *                subclass of <a href = "AroundDragger.html"><code>AroundDragger</code></a>.
     * @param pSide2  int</code>, the border of first edge as defined in <a
     *                href = "OpdBaseComponent.html"><code>OpdBaseComponent</code></a>.
     * @param pParam2 double</code>, connection parameter for positioning
     *                the connection point on the component's border.
     */
