...
public class EditControl {
    ...
    public OpdProject getCurrentProject() {
        if (this.myOpcat == null) {
            OpcatLogger.error("EditControl was not initiated by Opcat2");
        }
     ...
     * item.
     *
     * @param doEnable If <code>true</code>, the option would be displayed as
     ...
     *
     * @param globelDESelction true if to remove selection from all Project
     */
