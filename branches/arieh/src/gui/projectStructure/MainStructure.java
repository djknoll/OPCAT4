...
//        if (parent != null) {
//            pOpd.getProperties().setProperty("opd.general.tree.level", String.valueOf(String.valueOf(Integer.valueOf(parent.getProperties().getProperty("opd.general.tree.level")) + 1)));
//            pOpd.getProperties().setProperty("opd.general.tree.childrencount", String.valueOf(0));
//            pOpd.getProperties().setProperty("opd.general.tree.numinlevel", String.valueOf(Integer.valueOf(parent.getProperties().getProperty("opd.general.tree.childrencount")) + 1));
//            parent.getProperties().setProperty("opd.general.tree.childrencount", String.valueOf(Integer.valueOf(parent.getProperties().getProperty("opd.general.tree.childrencount")) + 1));
//        } else {
//            /**
//             * only one root SD in opcat model
//             */
//            pOpd.getProperties().setProperty("opd.general.tree.level", String.valueOf(1));
//            pOpd.getProperties().setProperty("opd.general.tree.childrencount", String.valueOf(0));
//            pOpd.getProperties().setProperty("opd.general.tree.numinlevel", String.valueOf(1));
//            //parent.getProperties().setProperty("opd.general.tree.childrencount",String.valueOf(Integer.valueOf(parent.getProperties().getProperty("opd.general.childrencount")) + 1 ));
//        }
...
//        }
    ...
    public Enumeration<Instance> getInstancesInOpd(long opdId) {
        ...
        /**
         * patch to fix OPL which is calling with non existing opdid
         */
        if (opdInstances.get(opdId) == null) {
            return new Vector<Instance>().elements();
        }

        return opdInstances.get(opdId).elements();
