...
//    }
    ...
    public String toString() {
        ...
        String name;
        if (isView()) {
            name = myProject.getSystemStructure().getOPDTextPath(getViewInitials(), this) + " : " + this.opdName;
        } else {
            name = myProject.getSystemStructure().getOPDTextPath(getSDInitials(), this) + " : " + this.opdName;
        }
        return name;
    }
    ...
    public BufferedImage getImageRepresentation() {
        ...
        return getImageRepresentation(dArea, dArea.getWidth(), dArea.getHeight(), dArea.getBackground());
    }
