...
//		if (thing.getCode() != null) {
//			Iterator<Element> iter = thing.getCode().iterator();
//			while (iter.hasNext()) {
//				codeElement.addContent(iter.next());
//			}
//			xmlThing.addContent(codeElement);
//		}
    ...
    protected Element _saveThingInstanceAttr(ThingInstance tInstance)
        ...
        xmlThingIns
                .setAttribute("order", String.valueOf(tInstance.getOrder()));
