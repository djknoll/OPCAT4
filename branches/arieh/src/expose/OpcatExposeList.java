...
public class OpcatExposeList {
    ...
    private void fillData(ArrayList<OpcatExposeEntity> data) {
        for (OpcatExposeEntity entity : data) {
            ...
            panel.getGrid().addRow(row, rowTag, false);
            // }
        }
    }
...
class MyImageIcon extends ImageIcon implements Comparable {

    private String name;

    MyImageIcon(String name) {
        this.name = name;
    }

    public boolean equals(Object o) {
        if (o instanceof MyImageIcon) {
            MyImageIcon in = (MyImageIcon) o;
            if (name.equalsIgnoreCase(in.getName())) return true;
        }
        return false;
    }
    ...
    public int compareTo(Object o) {
        if (o instanceof MyImageIcon) {
            MyImageIcon in = (MyImageIcon) o;
            if (name.equalsIgnoreCase(in.getName())) return 0;
