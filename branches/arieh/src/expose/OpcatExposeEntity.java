...
public class OpcatExposeEntity {
    ...
    public OpcatExposeEntity(Entry myEntity, String userID) {
        ...
        try {
            ...
            if (myEntity.getMyProject().getMcURL() != null) {
                key = new OpcatExposeKey(
                        myEntity.getMyProject().getMcURL(), myEntity
