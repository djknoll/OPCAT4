...
public class MergeCommand {
     ...
     *
     * @param draggedInstance The thing which is going to be absorbed into the
     *                        target, and is going to be deleted
     * @param targetInstance  The thing which is going to remain after the merge
                    ...
                    if (linkInstance.getSourceInstance() instanceof StateInstance) {
                        ...
                        StateEntry state = ((ObjectEntry) targetEntry)
                                .getState(linkInstance.getSourceInstance()
                                        .getEntry().getName());
                        Enumeration<Instance> stateEnum = state.getInstances(false);
