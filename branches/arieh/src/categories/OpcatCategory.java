...
public class OpcatCategory {
    ...
    protected boolean load(MetaManager man) {
        ...
        try {
            meta = new MetaLibrary(MetaLibrary.TYPE_CLASSIFICATION, mySource.getPath(), DataCreatorType.DATA_TYPE_TEXT_FILE_CSV, DataCreatorType.REFERENCE_TYPE_CATEGORY_FILE);
    ...
    protected OpcatCategory(File categoryFile) throws FileNotFoundException, IOException {
        ...
        String type = hedToken.nextToken();
        bufRdr.close();
