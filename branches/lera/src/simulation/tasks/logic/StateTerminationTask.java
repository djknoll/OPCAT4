...
public class StateTerminationTask extends LogicalTask {
...
//		public final static String NEW_INSTANCE_ID = "newInstanceId";
	...
	public StateTerminationTask(int startTime, IXSystem system, long ownerInstanceId, String name, LogicalTask parentTask) {
		super(startTime, system, TYPE.TERMINATION, parentTask);
		this.ownerInstanceId = ownerInstanceId;
		stateName = name;
	}

	public StateTerminationTask(NamedNodeMap attributes, IXSystem opmSystem,
