...
public class Repository extends JPanel implements ChangeListener {
	...
	public final static int OPDVIEW = 0;

	public final static int OPDThingsVIEW = 1;

	public final static int ThingsVIEW = 2;

	public final static int MetaVIEW = 3;

	public final static int RolesVIEW = 4;
	...
	public Repository(OpdProject prj, Opcat2 opcat2) {
		...
		OpcatOutLookBar outlookBar = new OpcatOutLookBar(this);
		this.add(outlookBar);
	...
	public void changeView(int i) {
		...
		if (this.project != null)  this.rebuildTrees(true);
