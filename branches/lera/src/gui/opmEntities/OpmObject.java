...
public class OpmObject extends OpmThing {
	...
	public void copyPropsFrom(OpmObject origin) {
		...
		this.currentValue = origin.getCurrentValue();
	...
	/**
	 * Returns current value of if this OpmObject.
	 * 
	 */
	...
	/**
	 * Sets current value of if this OpmObject.
	 * 
	 */
	...
	public boolean canBeGeneric() {
		...
		if (ThingEntry.getEntryFromOpmThing(this) != null) {
			...
			Iterator iter = Collections.list(
					ThingEntry.getEntryFromOpmThing(this).getInstances())
					.iterator();
