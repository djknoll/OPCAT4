...
*/
	...
	public StateInstance(StateEntry myEntry,OpdKey myKey, OpdObject pParent, OpdProject project)
	{
        ...
        this.myConnectionEdge = new OpdState((OpmState)myEntry.getLogicalEntity(), this.myProject, myKey.getOpdId(), myKey.getEntityInOpdId());
		...
		if(myEntry.getInstancesNumber() > 0 ) {
			this.setVisible((( StateInstance) myEntry.getInstances().nextElement()).isVisible()) ;
		}
