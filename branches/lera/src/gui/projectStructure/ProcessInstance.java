...
*/
	...
	public ProcessInstance(ProcessEntry myEntry, OpdKey myKey, Container container, OpdProject project)
	{
          ...
          this.myConnectionEdge = new OpdProcess(myEntry, this.myProject, myKey.getOpdId(), myKey.getEntityInOpdId());
	...
	public void setBreakPoint(boolean isBreakPoint){
		((OpdProcess)myConnectionEdge).setBreakPoint(isBreakPoint);
	}
	
	public boolean isBreakPoint(){
		return ((OpdProcess)myConnectionEdge).isBreakPoint();
	}
  ...
  {
    this.copyPropsFrom((ProcessInstance)origin);
  }
 //endReuseComment
