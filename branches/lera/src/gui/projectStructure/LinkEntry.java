...
*/
    ...
    {
        ((OpmProceduralLink)this.logicalEntity).setMinReactionTime(minimumReactionTime);
    }
...
*/
    ...
    {
        ((OpmProceduralLink)this.logicalEntity).setMaxReactionTime(maximumReactionTime);
    }
