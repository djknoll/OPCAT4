...
public class RolesDialog extends JPanel {
	...
	private void initLists() {
		...
		this.selectedRoles = ((RolesManager)this.theThing.getRolesManager().clone()).getLoadedRolesVector(LibraryTypes.MetaLibrary); 
		...
		Enumeration ontologies = this.myProject.getMetaManager().getMetaLibraries(LibraryTypes.MetaLibrary);
		try {
