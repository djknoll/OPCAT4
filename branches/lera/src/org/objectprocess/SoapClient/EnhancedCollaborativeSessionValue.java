...
public class EnhancedCollaborativeSessionValue implements java.io.Serializable {
	...
	public java.lang.Object[] getAddedCollaborativeSessionsPermissions() {
		return this.addedCollaborativeSessionsPermissions;
	}

	public void setAddedCollaborativeSessionsPermissions(
			java.lang.Object[] addedCollaborativeSessionsPermissions) {
	...
	public void setCollaborativeSessionName(
			java.lang.String collaborativeSessionName) {
	...
	public org.objectprocess.SoapClient.Enhanced2CollaborativeSessionPermissionsValue[] getCollaborativeSessionsPermissions() {
		return this.collaborativeSessionsPermissions;
	}

	public void setCollaborativeSessionsPermissions(
			org.objectprocess.SoapClient.Enhanced2CollaborativeSessionPermissionsValue[] collaborativeSessionsPermissions) {
	...
	public java.lang.Object[] getOnceAddedCollaborativeSessionsPermissions() {
		return this.onceAddedCollaborativeSessionsPermissions;
	}

	public void setOnceAddedCollaborativeSessionsPermissions(
			java.lang.Object[] onceAddedCollaborativeSessionsPermissions) {
	...
	public java.lang.Object[] getRemovedCollaborativeSessionsPermissions() {
		return this.removedCollaborativeSessionsPermissions;
	}

	public void setRemovedCollaborativeSessionsPermissions(
			java.lang.Object[] removedCollaborativeSessionsPermissions) {
	...
	public java.lang.Object[] getUpdatedCollaborativeSessionsPermissions() {
		return this.updatedCollaborativeSessionsPermissions;
	}

	public void setUpdatedCollaborativeSessionsPermissions(
			java.lang.Object[] updatedCollaborativeSessionsPermissions) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof EnhancedCollaborativeSessionValue)) {
			return false;
		}
		...
		boolean _equals;
		_equals = true
				&& (((this.addedCollaborativeSessionsPermissions == null) && (other
						.getAddedCollaborativeSessionsPermissions() == null)) || ((this.addedCollaborativeSessionsPermissions != null) && java.util.Arrays
						.equals(
								this.addedCollaborativeSessionsPermissions,
								other
										.getAddedCollaborativeSessionsPermissions())))
				...
				&& (((this.collaborativeSessionName == null) && (other
						.getCollaborativeSessionName() == null)) || ((this.collaborativeSessionName != null) && this.collaborativeSessionName
						.equals(other.getCollaborativeSessionName())))
				&& (((this.collaborativeSessionsPermissions == null) && (other
						.getCollaborativeSessionsPermissions() == null)) || ((this.collaborativeSessionsPermissions != null) && java.util.Arrays
						.equals(this.collaborativeSessionsPermissions, other
								.getCollaborativeSessionsPermissions())))
				...
				&& (((this.lastUpdate == null) && (other.getLastUpdate() == null)) || ((this.lastUpdate != null) && this.lastUpdate
				...
				&& (((this.onceAddedCollaborativeSessionsPermissions == null) && (other
						.getOnceAddedCollaborativeSessionsPermissions() == null)) || ((this.onceAddedCollaborativeSessionsPermissions != null) && java.util.Arrays
						.equals(
								this.onceAddedCollaborativeSessionsPermissions,
								other
										.getOnceAddedCollaborativeSessionsPermissions())))
				...
				&& (((this.removedCollaborativeSessionsPermissions == null) && (other
						.getRemovedCollaborativeSessionsPermissions() == null)) || ((this.removedCollaborativeSessionsPermissions != null) && java.util.Arrays
						.equals(
								this.removedCollaborativeSessionsPermissions,
								other
										.getRemovedCollaborativeSessionsPermissions())))
				&& (((this.revisionID == null) && (other.getRevisionID() == null)) || ((this.revisionID != null) && this.revisionID
						.equals(other.getRevisionID())))
				&& (((this.terminated == null) && (other.getTerminated() == null)) || ((this.terminated != null) && this.terminated
						.equals(other.getTerminated())))
				&& (((this.tokenHolderID == null) && (other.getTokenHolderID() == null)) || ((this.tokenHolderID != null) && this.tokenHolderID
						.equals(other.getTokenHolderID())))
				&& (((this.tokenTimeout == null) && (other.getTokenTimeout() == null)) || ((this.tokenTimeout != null) && this.tokenTimeout
						.equals(other.getTokenTimeout())))
				&& (((this.updatedCollaborativeSessionsPermissions == null) && (other
						.getUpdatedCollaborativeSessionsPermissions() == null)) || ((this.updatedCollaborativeSessionsPermissions != null) && java.util.Arrays
						.equals(
								this.updatedCollaborativeSessionsPermissions,
								other
										.getUpdatedCollaborativeSessionsPermissions())))
				&& (((this.userTimeout == null) && (other.getUserTimeout() == null)) || ((this.userTimeout != null) && this.userTimeout
						.equals(other.getUserTimeout())));
	...
	public synchronized int hashCode() {
		...
		int _hashCode = 1;
		if (this.getAddedCollaborativeSessionsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getAddedCollaborativeSessionsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getAddedCollaborativeSessionsPermissions(), i);
		...
		if (this.getCollaborativeSessionsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getCollaborativeSessionsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getCollaborativeSessionsPermissions(), i);
				if ((obj != null) && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		...
		if (this.getOnceAddedCollaborativeSessionsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getOnceAddedCollaborativeSessionsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getOnceAddedCollaborativeSessionsPermissions(), i);
				if ((obj != null) && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		...
		if (this.getRemovedCollaborativeSessionsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getRemovedCollaborativeSessionsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getRemovedCollaborativeSessionsPermissions(), i);
				if ((obj != null) && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		...
		if (this.getUpdatedCollaborativeSessionsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getUpdatedCollaborativeSessionsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getUpdatedCollaborativeSessionsPermissions(), i);
				if ((obj != null) && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
	...
	static {
		...
		elemField.setXmlName(new javax.xml.namespace.QName("",
				"collaborativeSessionsPermissions"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://org/objectprocess/cmp",
		...
		elemField.setXmlName(new javax.xml.namespace.QName("",
				"onceAddedCollaborativeSessionsPermissions"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://schemas.xmlsoap.org/soap/encoding/", "Array"));
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		...
		elemField.setXmlName(new javax.xml.namespace.QName("",
				"removedCollaborativeSessionsPermissions"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://schemas.xmlsoap.org/soap/encoding/", "Array"));
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("", "tokenHolderID"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://schemas.xmlsoap.org/soap/encoding/", "int"));
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
		...
		elemField.setXmlName(new javax.xml.namespace.QName("",
				"updatedCollaborativeSessionsPermissions"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://schemas.xmlsoap.org/soap/encoding/", "Array"));
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
