...
/**
 * IXObjectEntry is an interface to logical representation of Object in OPM meaning
 */
...
public interface IXObjectEntry extends IXThingEntry
{
	...
	* @param true if OPM object is key
	*/
	...
	* @param new index name for this OPM Object.
	*/
	...
	* @param new index order of this OPM Object.
	*/
	...
	* @param new initial value of this OPM Object.
	*/
	 ...
	 * @param typeOriginId - the ID of IXObjectEntry that represents type definition
    ...
    /**
    * Returns Enumeration of IXStateEntry which contains all states belonging to this object.
    * Use the Enumeration methods on the returned object to fetch the
    * IXStateEntry sequentially
    */
    ...
    public Enumeration getStates();
  	...
  	*/
  	...
  	/**
  	* Determines whether the given IXObjectEntry is instance (objects related by instantiation relation).
  	* @return true if IXObjectEntry is instance.
  	*/
