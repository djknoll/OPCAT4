...
public interface IXStateEntry
  ...
  /**
   * Sets the IXStateEntry to be default or not according to given parameter.
  ...
  /**
   * Checks if IXStateEntry is active.
  ...
  /**
   * Sets the IXStateEntry to be active or not according to given parameter.
   * @param defaultState - true if state going to be active.
   */
