...
public class ImportDialog extends JDialog {
	...
	private void jbInit() throws Exception {
		this.border1 = new EtchedBorder(EtchedBorder.RAISED, Color.white, new Color(
				134, 134, 134));
		...
		if ((this.curr.getFileName() == null) || this.curr.getFileName().equals("")) {
		...
		this.chooseFileButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (ImportDialog.this.fc.getSelectedFile() != null) {
					ImportDialog.this.fileNameTextField.setText(ImportDialog.this.fc.getSelectedFile().getPath());
					String newDirectory = ImportDialog.this.fc.getSelectedFile().getParent();
