...
public class TestingSettingsWindow extends JDialog {
	...
	void populate() {
		this.jTextFieldStepDuration
				.setText(new Long(TestingSettings.STEP_DURATION).toString());
		...
		this.jTextFieldReactionTime
				.setText(new Long(TestingSettings.REACTION_TIME).toString());
		...
		this.jCheckBoxMoveBetweenOPD.setSelected(TestingSettings.MOVE_BETWEEN_OPD);
	...
	private void jbInit() throws Exception {
		...
		this.jRadioButtonProcessDurationFixed
				.addItemListener(new java.awt.event.ItemListener() {
					public void itemStateChanged(ItemEvent e) {
						TestingSettingsWindow.this.jRadioButtonProcessDurationFixed_itemStateChanged(e);
					}
				});
		...
		this.jRadioButtonReactionTimeFixed
				.addItemListener(new java.awt.event.ItemListener() {
					public void itemStateChanged(ItemEvent e) {
						TestingSettingsWindow.this.jRadioButtonReactionTimeFixed_itemStateChanged(e);
					}
				});
		...
		this.jTextFieldReactionTimeRandomStart
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(ActionEvent e) {
						TestingSettingsWindow.this.jTextFieldReactionTimeRandomStart_actionPerformed(e);
					}
				});
		...
		this.jTextFieldReactionTimeRandomEnd
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(ActionEvent e) {
						TestingSettingsWindow.this.jTextFieldReactionTimeRandomEnd_actionPerformed(e);
					}
				});
		this.jTextFieldProcessDurationRandomEnd
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(ActionEvent e) {
						TestingSettingsWindow.this.jTextFieldProcessDurationRandomEnd_actionPerformed(e);
					}
				});
		...
		this.jTextFieldProcessDurationRandomStart
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(ActionEvent e) {
						TestingSettingsWindow.this.jTextFieldProcessDurationRandomStart_actionPerformed(e);
					}
				});
		...
		this.jButtonDefault.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TestingSettingsWindow.this.jButtonDefault_actionPerformed(e);
			}
		});
		this.jButtonClose.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TestingSettingsWindow.this.jButtonClose_actionPerformed(e);
			}
		});
	...
	private boolean dataModified() {
		...
		if (this.jTextFieldProcessDuration.isEnabled()) {
			if (TestingSettings.PROCESS_DURATION != java.lang.Integer
