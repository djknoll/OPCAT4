...
[Setup]
AppName=Opcat II Simulation-beta
AppVerName=Opcat version II Simulation-beta
AppCopyright=Copyright � 1999-2005 Opcat, Inc.

OutputBaseFilename =unrestricted
DefaultDirName={pf}\Opcat-simulation-beta
DefaultGroupName=Opcat-simulation-beta
...
Source: conf.txt; DestDir: {app}; Flags: ignoreversion
Source: error.log; DestDir: {app}; Flags: ignoreversion
Source: salicense.dat; DestDir: {app}; Flags: ignoreversion


[Icons]
Name: {group}\Opcat-simulation-beta; Filename: {app}\Opcat2.jar; WorkingDir: {app}; IconFilename: {app}\Opcat2_16x16.ico
Name: {userdesktop}\Opcat-simulation-beta; Filename: {app}\Opcat2.exe; WorkingDir: {app}; IconFilename: {app}\Opcat2_32x32.ico; IconIndex: 0
Name: {userappdata}\Microsoft\Internet Explorer\Quick Launch\Opcat-simulation-beta; Filename: {app}\Opcat2.exe; WorkingDir: {app}; IconFilename: {app}\Opcat2_32x32.ico; IconIndex: 0

[Dirs]

[Run]
Filename: {app}\Opcat2.exe; Description: Launch Opcat-simulation-beta; Flags: shellexec postinstall skipifsilent
...
Root: HKCU; Subkey: Environment; ValueType: string; ValueName: OPCAT_HOME; ValueData: {app}; Flags: uninsdeletevalue
