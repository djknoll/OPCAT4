  ...
  <tr>
    ...
    <td><table width="920" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td><table width="920" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="140" align="left" valign="top"><%@ include file="navigation.jsp" %></td>
                <td width="30">&nbsp;</td>
                        ...
                        <tr>
                          <td><table width="100%" border="0" cellspacing="1" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td class="tableRowRight">
                                	<input name="description" type="text" class="TextBoxControl" ></td>
                              </tr>
                              <tr>
                                <td class="tableRowLeft">Administrator :</td>
                                <td class="tableRowRight">
                                	<input name="administrator" type="checkbox" class="CheckBoxControl"></td>
                              </tr>
                              <tr>
                                <td class="tableRowLeft"><input type="hidden" name="action" value="newuser"></td>
