 ...
 * @lomboz generated
 */
public class EditableCollaborativeSessionValue
   ...
   implements java.io.Serializable 
{
   ...
   public EditableCollaborativeSessionValue( java.lang.String collaborativeSessionID,java.lang.String collaborativeSessionName,java.lang.String description,java.lang.String opmModelID,java.lang.String revisionID,java.lang.Integer tokenTimeout,java.lang.Integer userTimeout )
   {
   ...
   public EditableCollaborativeSessionValue( EditableCollaborativeSessionValue otherValue )
   {
   ...
   public String toString()
   {
	  ...
	  str.append("collaborativeSessionID=" + getCollaborativeSessionID() + " " + "collaborativeSessionName=" + getCollaborativeSessionName() + " " + "description=" + getDescription() + " " + "opmModelID=" + getOpmModelID() + " " + "revisionID=" + getRevisionID() + " " + "tokenTimeout=" + getTokenTimeout() + " " + "userTimeout=" + getUserTimeout());
	  str.append('}');
   ...
   public boolean equals(Object other)
   {
	  ...
	  if (other instanceof EditableCollaborativeSessionValue)
	  {
		 EditableCollaborativeSessionValue that = (EditableCollaborativeSessionValue) other;
