 ...
 * @lomboz generated
 */
public class UpdatableUserValue
   ...
   implements java.io.Serializable 
{
   ...
   public UpdatableUserValue( java.lang.String userID,java.lang.String loginName,java.lang.String firstName,java.lang.String lastName,java.lang.String password,java.lang.String email,java.lang.Boolean enabled,java.lang.String description )
   {
	  this.userID = userID;
   ...
   public UpdatableUserValue( UpdatableUserValue otherValue )
   {
   ...
   public String toString()
   {
	  ...
	  str.append("userID=" + getUserID() + " " + "loginName=" + getLoginName() + " " + "firstName=" + getFirstName() + " " + "lastName=" + getLastName() + " " + "password=" + getPassword() + " " + "email=" + getEmail() + " " + "enabled=" + getEnabled() + " " + "description=" + getDescription());
	  str.append('}');
   ...
   public boolean equals(Object other)
   {
	  ...
	  if (other instanceof UpdatableUserValue)
	  {
		 UpdatableUserValue that = (UpdatableUserValue) other;
