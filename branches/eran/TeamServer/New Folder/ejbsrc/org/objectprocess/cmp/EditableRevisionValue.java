 ...
 * @lomboz generated
 */
public class EditableRevisionValue
   ...
   implements java.io.Serializable 
{
   ...
   public EditableRevisionValue( java.lang.String revisionID,java.lang.String opmModelID,java.lang.String opmModelFile,java.lang.Integer majorRevision,java.lang.Integer minorRevision,java.lang.Integer build,java.lang.String comitterID,java.lang.String description )
   {
   ...
   public EditableRevisionValue( EditableRevisionValue otherValue )
   {
   ...
   public String toString()
   {
	  ...
	  str.append("revisionID=" + getRevisionID() + " " + "opmModelID=" + getOpmModelID() + " " + "opmModelFile=" + getOpmModelFile() + " " + "majorRevision=" + getMajorRevision() + " " + "minorRevision=" + getMinorRevision() + " " + "build=" + getBuild() + " " + "comitterID=" + getComitterID() + " " + "description=" + getDescription());
	  str.append('}');
   ...
   public boolean equals(Object other)
   {
	  ...
	  if (other instanceof EditableRevisionValue)
	  {
		 EditableRevisionValue that = (EditableRevisionValue) other;
