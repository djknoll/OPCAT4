 ...
 * @lomboz generated
 */
public class EditableWorkgroupValue
   ...
   implements java.io.Serializable 
{
   ...
   public EditableWorkgroupValue( java.lang.String workgroupID,java.lang.String workgroupName,java.lang.String description )
   {
   ...
   public EditableWorkgroupValue( EditableWorkgroupValue otherValue )
   {
   ...
   public String toString()
   {
	  ...
	  str.append("workgroupID=" + getWorkgroupID() + " " + "workgroupName=" + getWorkgroupName() + " " + "description=" + getDescription());
	  str.append('}');
   ...
   public boolean equals(Object other)
   {
	  ...
	  if (other instanceof EditableWorkgroupValue)
	  {
		 EditableWorkgroupValue that = (EditableWorkgroupValue) other;
