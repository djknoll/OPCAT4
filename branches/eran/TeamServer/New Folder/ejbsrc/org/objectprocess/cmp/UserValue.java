   ...
   implements java.io.Serializable 
{
   ...
   public UserValue( java.lang.String userID,java.lang.String loginName,java.lang.String firstName,java.lang.String lastName,java.lang.String email,java.lang.Boolean enabled,java.lang.Boolean loggedIn,java.util.Date lastLoginTime,java.lang.String description,java.lang.Boolean administrator )
   {
	  this.userID = userID;
   ...
   public String toString()
   {
	  ...
	  str.append("userID=" + getUserID() + " " + "loginName=" + getLoginName() + " " + "firstName=" + getFirstName() + " " + "lastName=" + getLastName() + " " + "email=" + getEmail() + " " + "enabled=" + getEnabled() + " " + "loggedIn=" + getLoggedIn() + " " + "lastLoginTime=" + getLastLoginTime() + " " + "description=" + getDescription() + " " + "administrator=" + getAdministrator());
	  str.append('}');
