...
public class OpmObject extends OpmThing {
    ...
    /**
         * Creates an OpmObject with specified id and name. Id of created
         * OpmObject must be unique in OPCAT system. Other data members of
         * OpmObject get default values.
         * 
         * @param id
         *                OpmObject id
         * @param name
