...
public class ReuseImportAction extends FileAction {
	...
	ImportDialog dialog = new ImportDialog(this.fileControl
		.getCurrentProject(), this.myGuiControl.getDesktop(), showConnectType);
