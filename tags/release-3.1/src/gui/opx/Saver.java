...
public class Saver {
	...
	File backupFile = new File(Configuration.getInstance().getProperty("backup_directory")
	...
	try {
	    ...
	    String msg = "Saving error occured on file " + fileName
		    + " on saver version " + this.usedVersion
		    + "\n Error text: " + sex.getMessage();
	    SaveException sexFull = new SaveException(msg);
	    OpcatLogger.logError(sexFull);
	    OpcatLogger.logError(sex);
    ...
    /**
         ...
         * version of the system is the latest version then
         * <code>SaverVer3</code> is used. Otherwise, the method asks the user
         * if to convert to the up-to-date version or to save in the old
         * verison.
         * 
         * @param version
         *                The version of the current project.
         * @return The appropiriate <code>SaverI</code> implementation, or
         *         null if the user had decided to cancel the save operation.
         */
