...
public class StatePropertiesDialog extends JDialog implements OpcatDialog, ComponentListener {
    ...
    /**
         ...
         * @param <code>pState OpdState</code> -- the OPD State to show
	...
	try {
	    ...
	    this.description = new JTextArea(this.stateEntry.getDescription(), 5,
		    30);
	    ...
	    // 2 tab
	    this.isInitial = new JCheckBox("Initial", this.stateEntry.isInitial());
	    this.isFinal = new JCheckBox("Final", this.stateEntry.isFinal());
	    this.isDefault = new JCheckBox("Default", this.stateEntry.isDefault());
	...
	// set icon
	this.iconPath = new JTextArea(myInstance.getEntry().getIconPath().trim(), 2, 24);
...
//	tab.add(this.p2);
		...
		this.bgColor.addActionListener(new BgColorButtonListener());
//		bgColor.putClientProperty("gradientStart", myInstance.getBackgroundColor());
//		bgColor.putClientProperty("gradientEnd", myInstance.getBackgroundColor());
...
//		textColor.putClientProperty("gradientStart", myInstance.getBackgroundColor());
//		textColor.putClientProperty("gradientEnd", myInstance.getBackgroundColor());
		this.borderColor.addActionListener(new BorderColorButtonListener());
//		borderColor.setBackground(myInstance.getBorderColor());
//		borderColor.setForeground(myInstance.getBorderColor());
//		borderColor.putClientProperty("gradientStart", myInstance.getBackgroundColor());
//		borderColor.putClientProperty("gradientEnd", myInstance.getBackgroundColor());
		this.p2.add(this.bgColor);
		this.p2.add(Box.createVerticalStrut(8));
		this.p2.add(this.textColor);
		this.p2.add(Box.createVerticalStrut(8));
		...
		this.iconButton.addActionListener(new IconListner(myInstance.getEntry(), this));
