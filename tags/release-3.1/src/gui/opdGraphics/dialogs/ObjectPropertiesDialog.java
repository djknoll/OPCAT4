...
public class ObjectPropertiesDialog extends JDialog implements
	...
	private JTextArea name, description, url, iconPath, generaldescription /*
																			 * ,
																			 * type
																			 */;
	 ...
	 *            <code>null</code>
	 * @param <code>OpdObject pObject</code> -- the OPD object to show properties
	 *            dialog for.
	 * @param <code>ThingEntry pEntry</code> -- the
	 *            <code>projectStructure.ThingEntry</code> class, entry of
	 *            this OPD Object in project dynamic structure.
	...
	private void _initVariables() {
		try {
			if ((this.showTabs & BaseGraphicComponent.SHOW_1) != 0) {
				...
				this.showIcon = new JCheckBox("Show Icon for this appearance ?" , opdObject.isIconVisible());
...
//		tab.add(this.p1);
	...
	private boolean _updateObjectData() {
		...
		this.object.getRolesManager().replacePoliciesRoles(this.rolesTab.getRoles());
