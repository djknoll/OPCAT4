...
public class ProjectPropertiesDialog extends JDialog {
    ...
    /**
         * Contains a dialog in which the user can select the libraries to
         * import.
         * 
         * @author Eran Toch
         */
    ...
    /**
         * Builds and constructs the dialog. THe method initialize all the
         * dialog variables (name, creator, date and all the general informaiton
         * variables. The general information variables are hard coded into the
         * code in this method. The code should be updated if any change should
         * be done to the list.
         * 
         * @see GenInfoEntry
         */
    ...
    /**
         * Changes the selection of the general information entry. The method
         * saves the last entry value in the <code>informations</code> array.
         * Afterwards, the method changes the <code>textarea</code> input
