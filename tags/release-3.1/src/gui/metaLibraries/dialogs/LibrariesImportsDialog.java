...
public class LibrariesImportsDialog extends JPanel {
    ...
    /**
         * Returns a Vector containing the Libraries to be displayed in the
         * list.
         */
    ...
    /**
         * Returns the text that would be displayed to the user, above the
         * libraries list.
         * 
         * @return
         */
    ...
    /**
         * Adding a new library to the system. The new library is added using
         * the <code>LibraryLocationDialog</code> which allows users to browse
         * for libraries using a file chooser or a URL.
         * 
         * @param e
         *                ActionEvent
         */
	...
	LibraryLocationDialog addLocation = new LibraryLocationDialog(
		this.parentFrame, "", MetaLibrary.TYPE_FILE,
	...
	if (newRef != null) {
	    ...
	    MetaLibrary newLib = this.metaManager
    ...
    /**
         ...
         * replaced with the one defined by the user if the new values are
	...
	if (this.importedList.getSelectedValue() != null) {
	    PathObject selectedPathValue = (PathObject) this.importedList
		    .getSelectedValue();
	    MetaLibrary edited = this.metaManager.findByPath(selectedPathValue
		    .getFullPath());
	    if (edited == null) {
		return;
	    }
	...
	if (this.importedList.getSelectedValue() != null) {
	    ...
	    MetaLibrary candidate = this.metaManager.findByPath(selectedValue);
		...
		this.metaManager.markForRemoval(selectedValue);
	    } catch (MetaException E) {
		JOptionPane.showMessageDialog(this, E.getMessage(), "Message",
			JOptionPane.ERROR_MESSAGE);
	    }
