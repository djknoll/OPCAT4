...
public class OpcatFile extends File {
	...
	public String toString() {
		if (isDirectory()) {
			return getName().substring(
					getName().lastIndexOf(FileControl.fileSeparator) + 1);
		} else {
	...
	/**
	 * This method return realPath as a  path relative to the ProjPath. any \.\ in
	 * the metaPath should be replaced by ProjPath when loading this path
	 * 
	 * @param projectPath
	 * @param metaPath
	 * @return
