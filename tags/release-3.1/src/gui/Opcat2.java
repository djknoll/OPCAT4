...
public class Opcat2 {
    ...
    private void _createSplashScreen() {
        ...
        String copyrightString = " OPCAT Systems (D.H) Ltd, All rights reserved (c) 2005-2010 \n";
     ...
     * automaticly.
     *
     * @param kindOfChange is OPL to be generated ?
     */
     ...
     *
     * @param flag <code>false</code> for not showing the message.
     ...
     *
     * @param metaLibraries A Vector containing <code>MetaLibrary</code> objects. If
    ...
    public void closeCleanUp() {
        ...
        getRepository().getModelsView().setRefrash(true);
     ...
     * user.
     *
     * @param isUndo If the parameter is <code>true</code>, then the operation
