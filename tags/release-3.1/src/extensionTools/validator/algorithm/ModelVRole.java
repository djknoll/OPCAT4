...
public class ModelVRole extends VRole {
	...
	/**
	 * The constructor allow setting the original <code>IConnectionEdgeEntry</code>,
	 ...
	 * @param _original	The original IConnectionEdgeEntry that the role belongs to.
	 */
	public ModelVRole(long _metaLibID, long _thingID, IConnectionEdgeEntry _original)	{
