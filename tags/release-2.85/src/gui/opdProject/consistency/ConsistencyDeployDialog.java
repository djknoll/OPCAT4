...
public class ConsistencyDeployDialog extends JDialog {
	...
	private void initialize() {
		...
		this.addWindowListener(new java.awt.event.WindowAdapter() {
			public void windowClosing(java.awt.event.WindowEvent e) {
				ConsistencyDeployDialog.this.setWindowClosing(true); // TODO Auto-generated Event stub
										// windowClosing()
			}
		});
			...
			this.jCancelButton
					.addActionListener(new java.awt.event.ActionListener() {
						public void actionPerformed(java.awt.event.ActionEvent e) {
							ConsistencyDeployDialog.this.setCancelPressed(true); // TODO Auto-generated Event
	...
	private JButton getOKJButton() {
		if (this.jOKButton == null) {
			...
			this.jOKButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					ConsistencyDeployDialog.this.setOkPressed(true); // TODO Auto-generated Event stub
										// actionPerformed()
					ConsistencyDeployDialog.this.setVisible(false);
				}
			});
	...
	private JButton getNextButton() {
		if (this.jNextButton == null) {
			...
			this.jNextButton.setText("Next");
			this.jNextButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					ConsistencyDeployDialog.this.setNextPresed(true); // TODO Auto-generated Event stub
											// actionPerformed()
					ConsistencyDeployDialog.this.setVisible(false);
				}
			});
	...
	private JButton getJAllButton() {
		if (this.jAllButton == null) {
			...
			this.jAllButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					ConsistencyDeployDialog.this.setAutoPressed(true); // TODO Auto-generated Event stub
											// actionPerformed()
					ConsistencyDeployDialog.this.setVisible(false);
				}
			});
