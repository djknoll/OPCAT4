...
*/
	...
	protected boolean hasSameProps(OpmThing pThing)
	{
		return (super.hasSameProps(pThing) &&
				...
				(this.numberOfInstances == pThing.getNumberOfInstances()) &&
				(this.getRolesManager().equals(pThing.getRolesManager())));
	}
	...
	public String getRole()
	{
		...
		if (this.rolesManager != null) {
			if (this.getRolesManager().hasRoles())	{
				...
				output += this.getRolesManager().getRolesText(Types.MetaLibrary);
			}
		}
		return output;
	}
