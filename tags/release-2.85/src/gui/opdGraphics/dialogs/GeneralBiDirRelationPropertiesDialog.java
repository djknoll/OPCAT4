...
public class GeneralBiDirRelationPropertiesDialog extends JDialog implements
	...
	public GeneralBiDirRelationPropertiesDialog(
		...
		sId = this.biDirGeneralRelation.getSourceId();
		dId = this.biDirGeneralRelation.getDestinationId();
	...
	public void commitLockForEdit() {
		...
		this.destinationCardinality.setEditable(false);
		this.customSourceCardinality.setEditable(false);
		this.customDestinationCardinality.setEditable(false);
		this.forwardRelationMeaning.setEditable(false);
		this.backwardRelationMeaning.setEditable(false);
