...
public class LinkPopup extends DefaultPopup {
	...
	Action propertiesAction = new AbstractAction("Properties",
		...
		public void actionPerformed(ActionEvent e) {
			((LinkInstance) (LinkPopup.this.myProject.getCurrentOpd().getSelectedItem()))
					.getSourceDragger().callPropertiesDialog();
	...
	Action arrangeAction = new AbstractAction("Auto Arrange") {
		...
		public void actionPerformed(ActionEvent e) {
			LinkPopup.this.myInstance.setAutoArranged(!LinkPopup.this.myInstance.isAutoArranged());
		}
	};
