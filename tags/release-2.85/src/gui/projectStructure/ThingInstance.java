...
*/
	public ThingInstance(OpdKey myKey, OpdProject project)
	{
		...
		this.zoomedIn = false;
                //reuseComment
                this.targetThingInstance=null;
                this.targetBackgroundColor=null;
                //endReuseComment
	}
...
*/
	...
	{
		this.unfoldingOpd = pUnfoldingOpd;
...
*/
	...
	public void update()
	{
		...
		if (this.unfoldingOpd != null)
		{
			StringTokenizer st = new StringTokenizer(this.unfoldingOpd.getName(), " ");
			this.unfoldingOpd.setName(st.nextToken() + " - "+ logThing.getName().replace('\n',' ') + " unfolded");
		}

		if ( (((ThingEntry)this.getEntry()).getZoomedInOpd()!=null) || (this.unfoldingOpd != null))
		{
	...
	public int getLayer()
	{
		return ((JLayeredPane)this.myConnectionEdge.getParent()).getPosition(this.myConnectionEdge);
	}

	public void setLayer(int position)
	{
		((JLayeredPane)this.myConnectionEdge.getParent()).setPosition(this.myConnectionEdge, position);
	}
	...
	private Enumeration _getIncludedSomethingInstances(int what)
	{
		...
		Enumeration e = this.myProject.getComponentsStructure().getInstancesInOpd(this.getKey().getOpdId());
		Instance inst = null;
	...
	public Enumeration getIncludedFundamentalRelationInstances()
	{
      ...
      //reuseCommnet
        ...
        {
          this.targetThingInstance=aThingInstance;
        }

        public ThingInstance getTargetThingInstance()
        {
          return this.targetThingInstance;
        }

        public void setTargetBackgroundColor(Color aBackgroundColor)
        {
          this.targetBackgroundColor=aBackgroundColor;
        }
