...
*/
	...
	{
		return (GraphicalRelationRepresentation)(this.graphicalRepresentations.put(pKey, gRepresentation));
	}
...
*/
	...
	public IXEntry getIXEntry(long pKey)
	{
		...
		{
		  GraphicalRelationRepresentation gRelR = (GraphicalRelationRepresentation)this.graphicalRepresentations.get(pKey);
...
*/
	...
	{
		return this.mStructure.elements();
	}
...
*/
	public Enumeration getGraphicalRepresentations()
	{
        ...
        public Enumeration getGraphicalRepresentationsInOpd(long opdId)
        {
          ...
          for (Enumeration e = this.getGraphicalRepresentations(); e.hasMoreElements();)
          {
	...
	{
          return (GraphicalRelationRepresentation)this.graphicalRepresentations.get(pKey);
	}


		public ConnectionEdgeEntry getSourceEntry(OpmStructuralRelation relation)
		{
		  return (ConnectionEdgeEntry)this.mStructure.get(new Long(relation.getSourceId()));
		}

		public ConnectionEdgeEntry getSourceEntry(OpmProceduralLink link)
		{
		  return (ConnectionEdgeEntry)(this.mStructure.get(new Long(link.getSourceId())));
		}

		public ConnectionEdgeEntry getDestinationEntry(OpmStructuralRelation relation)
		{
		  return (ConnectionEdgeEntry)(this.mStructure.get(new Long(relation.getDestinationId())));
		}

		public ConnectionEdgeEntry getDestinationEntry(OpmProceduralLink link)
		{
		  return (ConnectionEdgeEntry)(this.mStructure.get(new Long(link.getDestinationId())));
		}
	...
	public Enumeration getInstancesInOpd(long opdId)
	{
		...
		Entry tempEnt;
		Instance tempIns;
		for(Enumeration ee = this.getElements(); ee.hasMoreElements();)
		{
