...
public final class OPLTreePerOPDBuilder
  ...
  public OPLTreePerOPDBuilder(ISystemStructure myStructure_,
    ...
    this.opd = opd_;
    this.currOPD = opd_;
    if((this.myStructure == null) || (this.myStructure.getIOpd(this.opd)== null) || (this.myStructure.getIOpd(this.opd).getParentIOpd()==null)){
      this.mainElem = null;
    } else {
...
//  }
  ...
  protected boolean testEntity(IEntry entity) {
    if(entity instanceof IStateEntry){
      return ((IStateEntry)entity).hasVisibleInstancesInOpd(this.opd);
