...
class AnimationGUIPanel extends JPanel {
	...
	public AnimationGUIPanel(IXSystem sys) {
		this.mySys = sys;
		this.aSys = new AnimationSystem(this.mySys, this.jLabelAnimationStatus);
		try {
			this.jbInit();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private void jbInit() throws Exception {
		...
		this.runButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.runButton_actionPerformed(e);
			}
		});
		...
		this.stopButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.stopButton_actionPerformed(e);
			}
		});
		...
		this.pauseButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.pauseButton_actionPerformed(e);
			}
		});
		...
		this.continueButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.continueButton_actionPerformed(e);
			}
		});
		...
		this.forwardButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.forwardButton_actionPerformed(e);
			}
		});
		...
		this.backwardButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.backwardButton_actionPerformed(e);
			}
		});
		...
		this.activateButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.activateButton_actionPerformed(e);
			}
		});
		...
		this.deactivateButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.deactivateButton_actionPerformed(e);
			}
		});
		...
		this.settingsButton.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.settingsButton_actionPerformed(e);
			}
		});
		...
		this.help.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AnimationGUIPanel.this.help_actionPerformed(e);
			}
		});
		...
		this.jTextFieldForwardSteps
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(ActionEvent e) {
						AnimationGUIPanel.this.jTextFieldForwardSteps_actionPerformed(e);
					}
				});
		...
		this.jLabelAnimationStatus.setPreferredSize(new Dimension(41, 17));
		...
		this.jPanel1.add(this.jLabelAnimationStatus, null);
	...
	void pauseButton_actionPerformed(ActionEvent e) {
		this.aSys.animationPause();
		this.forwardButton.setEnabled(true);
		this.backwardButton.setEnabled(true);
	}

	void continueButton_actionPerformed(ActionEvent e) {
		this.aSys.animationContinue();
	}
	...
	void forwardButton_actionPerformed(ActionEvent e) {
		...
		this.aSys.animationForward(numberOfSteps);
	}
