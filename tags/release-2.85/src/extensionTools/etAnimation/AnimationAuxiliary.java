...
class AnimationAuxiliary extends Object {
	...
	public static final String AnimationPanelName = "Animation Log";

	public static final String ActionActivate = "Activate";

	public static final String ActionTerminate = "Terminate";

	public static final String ActionGlobel = "Globel";
	...
	public static void debug(Vector x) {
		// int i = 0 ;
		//	  
		// for (i = 0 ; i < x.size() ; i++) {
		// APILogger.Print(x,x.elementAt(i).toString());
		// }
	}

	public static void debug(Object x, String Message) {
		// APILogger.Print(x,Message);
	}

	public static void debug(String Message) {
		// APILogger.Print("Null",Message);
	}
}