...
//	protected int shiftLine;
	...
	public Point getUpperPoint()
	{
		...
		{
			retPoint.setLocation(this.edge1.getX()+p1.getX()
						  ,this.edge1.getY()+p1.getY());
		}
		else
		{
			retPoint.setLocation(this.edge2.getX()+p2.getX()
	...
	public void mousePressed(MouseEvent e)
	{
		...
		//		  myProject.removeSelection();
		  Entry myEntry = this.myProject.getComponentsStructure().getEntry(this.myEntity.getId());
