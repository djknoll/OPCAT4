...
//    public static RelativeConnectionPoint calculateConnectionPoint(OpdConnectionEdge mainItem, OpdConnectionEdge secondItem)
	public static RelativeConnectionPoint calculateConnectionPoint(Connectable mainItem, Connectable secondItem)
	{
		...
		if (mainItem instanceof OpdProcess)
		{
			...
			{
			  return new RelativeConnectionPoint(OpcatConstants.N_BORDER, (x+a)/mainItem.getActualWidth());
			}

			if ((sItemCenter.getY()>=0) && (sItemCenter.getX()<=0))
			{
			  return new RelativeConnectionPoint(OpcatConstants.N_BORDER, (a-x)/mainItem.getActualWidth());
			}

			if ((sItemCenter.getY()<=0) && (sItemCenter.getX()>=0))
			{
			  return new RelativeConnectionPoint(OpcatConstants.S_BORDER, (x+a)/mainItem.getActualWidth());
			}

			if ((sItemCenter.getY()<=0) && (sItemCenter.getX()<=0))
			{
			  return new RelativeConnectionPoint(OpcatConstants.S_BORDER, (a-x)/mainItem.getActualWidth());
			}
