...
public class EnhancedWorkgroupValue implements java.io.Serializable {
	...
	public java.lang.Object[] getAddedWorkgroupsPermissions() {
		return this.addedWorkgroupsPermissions;
	}

	public void setAddedWorkgroupsPermissions(
			java.lang.Object[] addedWorkgroupsPermissions) {
	...
	public java.lang.Object[] getOnceAddedWorkgroupsPermissions() {
		return this.onceAddedWorkgroupsPermissions;
	}

	public void setOnceAddedWorkgroupsPermissions(
			java.lang.Object[] onceAddedWorkgroupsPermissions) {
	...
	public java.lang.Object[] getRemovedWorkgroupsPermissions() {
		return this.removedWorkgroupsPermissions;
	}

	public void setRemovedWorkgroupsPermissions(
			java.lang.Object[] removedWorkgroupsPermissions) {
		this.removedWorkgroupsPermissions = removedWorkgroupsPermissions;
	}

	public java.lang.Object[] getUpdatedWorkgroupsPermissions() {
		return this.updatedWorkgroupsPermissions;
	}

	public void setUpdatedWorkgroupsPermissions(
			java.lang.Object[] updatedWorkgroupsPermissions) {
	...
	public org.objectprocess.SoapClient.Enhanced2WorkgroupPermissionsValue[] getWorkgroupsPermissions() {
		return this.workgroupsPermissions;
	}

	public void setWorkgroupsPermissions(
			org.objectprocess.SoapClient.Enhanced2WorkgroupPermissionsValue[] workgroupsPermissions) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof EnhancedWorkgroupValue)) {
			return false;
		}
		...
		boolean _equals;
		_equals = true
				&& (((this.addedWorkgroupsPermissions == null) && (other
						.getAddedWorkgroupsPermissions() == null)) || ((this.addedWorkgroupsPermissions != null) && java.util.Arrays
						.equals(this.addedWorkgroupsPermissions, other
								.getAddedWorkgroupsPermissions())))
				...
				&& (((this.onceAddedWorkgroupsPermissions == null) && (other
						.getOnceAddedWorkgroupsPermissions() == null)) || ((this.onceAddedWorkgroupsPermissions != null) && java.util.Arrays
						.equals(this.onceAddedWorkgroupsPermissions, other
								.getOnceAddedWorkgroupsPermissions())))
				&& (((this.primaryKey == null) && (other.getPrimaryKey() == null)) || ((this.primaryKey != null) && this.primaryKey
						.equals(other.getPrimaryKey())))
				&& (((this.removedWorkgroupsPermissions == null) && (other
						.getRemovedWorkgroupsPermissions() == null)) || ((this.removedWorkgroupsPermissions != null) && java.util.Arrays
						.equals(this.removedWorkgroupsPermissions, other
								.getRemovedWorkgroupsPermissions())))
				&& (((this.updatedWorkgroupsPermissions == null) && (other
						.getUpdatedWorkgroupsPermissions() == null)) || ((this.updatedWorkgroupsPermissions != null) && java.util.Arrays
						.equals(this.updatedWorkgroupsPermissions, other
								.getUpdatedWorkgroupsPermissions())))
				...
				&& (((this.workgroupsPermissions == null) && (other
						.getWorkgroupsPermissions() == null)) || ((this.workgroupsPermissions != null) && java.util.Arrays
						.equals(this.workgroupsPermissions, other
	...
	public synchronized int hashCode() {
		...
		int _hashCode = 1;
		if (this.getAddedWorkgroupsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getAddedWorkgroupsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getAddedWorkgroupsPermissions(), i);
		...
		if (this.getOnceAddedWorkgroupsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getOnceAddedWorkgroupsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getOnceAddedWorkgroupsPermissions(), i);
				if ((obj != null) && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		...
		if (this.getRemovedWorkgroupsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getRemovedWorkgroupsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getRemovedWorkgroupsPermissions(), i);
				if ((obj != null) && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		}
		if (this.getUpdatedWorkgroupsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getUpdatedWorkgroupsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getUpdatedWorkgroupsPermissions(), i);
				if ((obj != null) && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		...
		if (this.getWorkgroupsPermissions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(this.getWorkgroupsPermissions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						this.getWorkgroupsPermissions(), i);
				if ((obj != null) && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
	...
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
			EnhancedWorkgroupValue.class);

	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName(
				"http://org/objectprocess/cmp", "EnhancedWorkgroupValue"));
		org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
		elemField.setFieldName("addedWorkgroupsPermissions");
		elemField.setXmlName(new javax.xml.namespace.QName("",
				"addedWorkgroupsPermissions"));
		...
		elemField.setXmlName(new javax.xml.namespace.QName("",
				"onceAddedWorkgroupsPermissions"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://schemas.xmlsoap.org/soap/encoding/", "Array"));
		typeDesc.addFieldDesc(elemField);
		elemField = new org.apache.axis.description.ElementDesc();
