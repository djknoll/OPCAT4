 ...
 * </p>
 * <p>
 * Description: a class that holds information about a segment number of points,
 * index of begining in vector points, the min/max points of the segment and a
 * flag that indicates the segments drawing direction.
 * </p>
 */
public class Segment extends EdgeValues {
	/**
	...
	/**
	 * private int startIndex indicates the start of the segment in the
	 * segment's array
	 */
	private int startIndex;// indicates the start of the segment in the
							// segment's array
	 ...
	 */
	protected boolean fromStart = true;// indicates the segments drawing
										// direction
	 ...
	 * 
	 * @param sindex
	 *            start index at points vector
	 * @param sSize
	 *            the number of points in segment
	 * @param maxx
	 *            the max x coordinate of the segment
	 * @param maxy
	 *            the max y coordinate of the segment
	 * @param minx
	 *            the min x coordinate of the segment
	 * @param miny
	 *            the min y coordinate of the segment
	 */
	public Segment(int sindex, int sSize, int maxx, int maxy, int minx, int miny) {
		super();
		this.startIndex = sindex;
		this.numOfPoints = sSize;
		this.setmaxX(maxx);
		this.setmaxY(maxy);
		this.setminX(minx);
		this.setminY(miny);
	 ...
	 *            the number of points in segment
	 * @param ev
	 *            the edge values of the segment
	 */
	 ...
	 * 
	 * @param s
	 *            creats a new Segment with the data of the old one
	 */
	public Segment(Segment s) {
		super(s);
		this.numOfPoints = s.getNumOfPoints();
		this.startIndex = s.getStartIndex();
		this.fromStart = s.isFromStart();
	}
	...
	/**
	 * the function setStartIndex updates the start index of segment in the
	 * vector
	 * 
	 * @param index
	 *            the start index
	 ...
	 * 
	 * @return the flag from start that indicates the drawing diraction of the
	 *         segment
	 */
...
/**
 * <p>
 * Title: class LineParam
 * </p>
 * <p>
 * Description:contains the a and b parameters of line equation
 * </p>
 */
class LineParam {
	/**
	 ...
	 * 
	 * @param param
	 *            the a and b parameters of line equation
	 */
	public LineParam(LineParam param) {
		this.aLine = param.getA();
		this.bLine = param.getB();
	}
