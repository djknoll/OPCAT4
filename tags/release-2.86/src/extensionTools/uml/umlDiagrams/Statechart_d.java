...
public class Statechart_d {
	...
	private void StateDoActivityNeeded(ISystemStructure MyStructure,
			FileOutputStream file, IStateEntry state) throws IOException {
		try {
			Enumeration e;
			int flag = 0;
			ILinkEntry link;
	 ...
	 * 
	 */
	private void simpleStatesCreate(ISystem sys, FileOutputStream file,
	 ...
	 *            be printed in Diagram_Creator.
	 */
	private void CreateStates(ISystem sys, FileOutputStream file,
	 ...
	 */
	private void CreateTransitions2(ISystem sys, FileOutputStream file,
	 ...
	 */
	private void CreateTransitions(ISystem sys, FileOutputStream file,
	 ...
	 *            be printed in Diagram_Creator.
	 */
	public void StateChartDiagramCreate(ISystem sys, FileOutputStream file,
