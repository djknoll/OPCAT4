...
public class ReuseCommand {
    ...
    protected void addReusedStates(ObjectInstance addedObject, ObjectInstance reusedFrom, Opd targetOpd) {
        ...
        while (e.hasMoreElements()) {
            ...
            targetStateInstance.setSize(addedReusedState.getConnectionEdge().getWidth(), addedReusedState.getConnectionEdge().getHeight());
            targetStateInstance.setLocation(addedReusedState.getConnectionEdge().getX(), addedReusedState.getConnectionEdge().getY());
