...
public class GeneralComparator implements Comparator {
  ...
  public int compare(Object o1, Object o2){
    ...
    try{
      return compareSystem(ent1, ent2);
  ...
  public int compareSystem(IEntry ent1, IEntry ent2)throws Exception{
    int first = 0;
    int second = 0;
    int fatherType1 = getFatherType(ent1,ent2);
    int fatherType2 = getFatherType(ent2,ent1);
    if(fatherType1>0)
      first = -1;
    if(fatherType2>0)
      second = 1;
  ...
  IEntry zoomFather = builder.getZoomingFather(ent2);
  if(zoomFather!=null)
    if(hasZoomingFather(ent1,ent2))return 1000;
