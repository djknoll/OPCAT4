...
public class ChangingSentenceTypeImpl implements extensionTools.opl2.generated.ChangingSentenceType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx4 = 0;
        final int len4 = _PathLabel.size();
        int idx5 = 0;
        final int len5 = _ChangingClause.size();
        ...
        while (idx5 != len5) {
            if (_ChangingClause.get(idx5) instanceof javax.xml.bind.Element) {
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ChangingClause.get(idx5 ++)));
            } else {
                context.startElement("", "ChangingClause");
                int idx_3 = idx5;
                context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _ChangingClause.get(idx_3 ++)));
                context.endAttributes();
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ChangingClause.get(idx5 ++)));
                context.endElement();
            }
        ...
        while (idx4 != len4) {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) _PathLabel.get(idx4 ++)));
            } catch (java.lang.Exception e) {
                com.sun.xml.bind.marshaller.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
            ...
            switch (state) {
                ...
                case  6 :
                    if (("" == ___uri)&&("MinimalCardinality" == ___local)) {
                        _ChangingClause.add(((extensionTools.opl2.generated.impl.ChangingClauseTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ChangingClauseTypeImpl.class), 7, ___uri, ___local, __atts)));
                        return ;
                    }
                    break;
                case  3 :
            ...
            switch (state) {
                case  6 :
                    if (("" == ___uri)&&("subjectAggregationFatherName" == ___local)) {
                        _ChangingClause.add(((extensionTools.opl2.generated.impl.ChangingClauseTypeImpl) spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.ChangingClauseTypeImpl.class), 7, ___uri, ___local)));
                        return ;
                    }
                ...
                case  11 :
                    if (("" == ___uri)&&("RoleName" == ___local)) {
                        _Role.add(((extensionTools.opl2.generated.impl.RoleTypeImpl) spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.RoleTypeImpl.class), 12, ___uri, ___local)));
                        return ;
                    }
