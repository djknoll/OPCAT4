            ...
            switch (state) {
                ...
                case  1 :
                    if (("" == ___uri)&&("IndexName" == ___local)) {
                        spawnSuperClassFromEnterElement((((extensionTools.opl2.generated.impl.ObjectIndexTypeImpl)extensionTools.opl2.generated.impl.ObjectIndexImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, __atts);
                        return ;
                    }
                    break;
            }
