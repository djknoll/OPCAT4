...
public class ObjectInheritanceSentenceSetTypeImpl implements extensionTools.opl2.generated.ObjectInheritanceSentenceSetType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
    ...
    public java.util.List getObjectInheritanceSentence() {
        return _ObjectInheritanceSentence;
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx3 = 0;
        final int len3 = _ObjectInheritanceSentence.size();
        ...
        while (idx3 != len3) {
            if (_ObjectInheritanceSentence.get(idx3) instanceof javax.xml.bind.Element) {
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ObjectInheritanceSentence.get(idx3 ++)));
            } else {
                context.startElement("", "ObjectInheritanceSentence");
                int idx_2 = idx3;
                context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _ObjectInheritanceSentence.get(idx_2 ++)));
                context.endAttributes();
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ObjectInheritanceSentence.get(idx3 ++)));
                context.endElement();
            }
            ...
            throws com.sun.xml.bind.unmarshaller.UnreportedException
        {
            switch (state) {
                case  0 :
                    ...
                    break;
                case  4 :
                    if (("" == ___uri)&&("InheritanceFatherName" == ___local)) {
                        _ObjectInheritanceSentence.add(((extensionTools.opl2.generated.impl.ObjectInheritanceSentenceTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ObjectInheritanceSentenceTypeImpl.class), 5, ___uri, ___local, __atts)));
                        return ;
                    }
                    break;
                case  3 :
                    ...
                    if (("" == ___uri)&&("ObjectInheritanceSentence" == ___local)) {
                        context.pushAttributes(__atts);
                        state = 4;
                        return ;
                    }
