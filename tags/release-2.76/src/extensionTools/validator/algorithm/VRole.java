...
/**
 * Represent a Validation Role which is used internally by the Validation algorithm.
 * @author Eran Toch
 * Created: 06/05/2004
 */
public class VRole {
	...
	/**
	 * A constructor method for a <code>VRole</code> object. Assignes the 
	 * ID's. 
	 * @param _thingID	The ID of the thing in the meta-library
	 * @param _metaLibID	The ID of the meta-library
	 */
	public VRole(long _metaLibID, long _thingID)	{
		thingID = _thingID;
		metaLibID = _metaLibID;
	}
	

	/**
	 * Checks if both objects have the same thingID and metaLibID.
	 * @param other	The other VRole to be compared.
	 * @return <code>true</code> if they are equal, <code>false</code> otherwise.
	 */
	public boolean equals(VRole other)	{
		if (this.metaLibID == other.getMetaLibID() && this.thingID == other.getThingID())	{
			return true;
		}
		return false;		
	}
	...
	public String toString()	{
		return getMetaLibID() +"."+ getThingID();
	}
}
