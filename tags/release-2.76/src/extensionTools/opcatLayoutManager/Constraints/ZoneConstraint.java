...
public class ZoneConstraint extends MultiNodeConstraint
{
    ...
    public String toString()
    {
        return MessageFormat.format( "[{0} in zone of {1}]",
                                     new Object[] {GetNodesString(), m_mainNodeConnection.m_node});
    }
    ...
    public LinkedList Attach()
    {
        ...
        if (null == m_springs)
        {
            ...
            for (ListIterator iterNodes = m_nodes.listIterator(); iterNodes.hasNext(); /* inside loop */)
            {
                ...
                Spring spring = new NodeNodeSpring(this, 0, m_mainNodeConnection, nodeConnection);
    ...
    {
        NodeContext   zoneNode = m_mainNodeConnection.m_node;
