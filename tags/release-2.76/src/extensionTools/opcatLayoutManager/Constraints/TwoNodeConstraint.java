...
public abstract class TwoNodeConstraint extends Constraint
{
                                 ...
                                 Comparator            comparator)
    {
        ...
        if (null != comparator && Constraint.directionOther != direction)
        {
            ...
            {
                SpringConnectionPoint tmp = m_nodeConnection2;
                m_nodeConnection2 = m_nodeConnection1;
                m_nodeConnection1 = tmp;
            }
        }
    }
    ...
    public void Show()
    {
        m_nodeConnection1.m_node.Select(true);
        m_nodeConnection2.m_node.Select(true);
    }
    ...
    public void Hide()
    {
        m_nodeConnection1.m_node.Select(false);
        m_nodeConnection2.m_node.Select(false);
    }
