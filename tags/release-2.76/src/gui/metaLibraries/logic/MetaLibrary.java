...
//	public static final int STATE_EDITED = 5;
	 ...
	 */
	private OpdProject holder = null;
...
//	}
	 ...
	 */
	public void setModelProject(OpdProject projectHolder) throws NullPointerException	{
		if (projectHolder == null)	{
			throw new NullPointerException("Project was passed null to the MetaLibrary");
		}
		holder = projectHolder;
		globalID = projectHolder.getGlobalID();
	...
	*/
	...
	public ISystemStructure getStructure() {
		return holder.getISystemStructure();
	}
	...
	public Collection getRolesCollection() throws MetaException	{
		...
		if (holder == null)	{
			throw new MetaException("Meta-Library is not loaded", getPath());
		}
		MainStructure oStructure = holder.getComponentsStructure();
	 ...
	 */
	public OpdProject getProjectHolder() {
		return holder;
	}
