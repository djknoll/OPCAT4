...
/**
 *  <p>This class defines Generalization relation as specified in OPM documentation
...
public class OpdSpecialization extends OpdFundamentalRelation
{
	 ...
	 *  @param <code>mAgg, <a href = "OpmGeneralization.html">OpmGeneralization</a></code> logical representation of OPM Generalization link
	 *  @param <code>pProject OpdProject</code>, OPD project this relation belongs to.
	 *  @param <code>pOpdId long</code>, uniqe identifier for the <a href = "../opdProject/Opd.html"><code>Opd</code></a> this Generalization relation added to.
	 ...
	 */
	public	OpdSpecialization(OpmSpecialization mGen, OpdProject pProject, long pOpdId, long pEntityInOpdId)
	{
	...
	public void paintComponent(Graphics g)
	{
        ...
        int xS[] = {selOffset,(int)Math.round((double)(getWidth()-1)/2), getWidth()-selOffset-1};
        int yS[] = {getHeight()-selOffset-1, selOffset, getHeight()-selOffset-1};
	...
	{
		RelationPropertiesDialog rd = new RelationPropertiesDialog(graphicalEntry, "Generalization-Specialization", false);
		rd.showDialog();
	}
