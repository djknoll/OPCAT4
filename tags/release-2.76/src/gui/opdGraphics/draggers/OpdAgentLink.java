...
public class OpdAgentLink extends OpdLink
{
	...
	public void  paintComponent(Graphics g)
	{
		...
		DoublePoint center = new DoublePoint( (double)getWidth()/2, (((double)getHeight())-size+1.0)/2 );
		center.rotate(angle, new DoublePoint( (double)getWidth()/2, (double)getHeight()/2));
	...
	{
		  LinkPropertiesDialog ld = new LinkPropertiesDialog(myLink, new OpdKey(getOpdId(), getEntityInOpdId()), myProject, "Agent");
		  ld.show();
	}
}
