...
/**
* <p>This class represents entry of OPM process.
*
* @version	2.0
...
public class ProcessEntry extends ThingEntry implements IXProcessEntry, IProcessEntry
{
...
*/
	...
	public ProcessEntry(OpmProcess pProcess, ThingEntry parentThing, OpdProject project)
	{
...
*/
	...
	{
		return ((OpmProcess)logicalEntity).getProcessBody();
	}
...
*/
	...
	{
		((OpmProcess)logicalEntity).setProcessBody(processBody);
	}
...
*/
	...
	{
		return ((OpmProcess)logicalEntity).getMaxTimeActivation();
	}
...
*/
	...
	{
		((OpmProcess)logicalEntity).setMaxTimeActivation(time);
	}
...
*/
	...
	{
		return ((OpmProcess)logicalEntity).getMinTimeActivation();
	}
...
*/
	...
	{
		((OpmProcess)logicalEntity).setMinTimeActivation(time);
	}
