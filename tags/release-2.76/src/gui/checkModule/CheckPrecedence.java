...
public class CheckPrecedence {
  ...
  {
    initLinkCheckPrecednceTable();
    initRelationCheckPrecedenceTable();
  }
  /************************************************************************/
  /* Class: initCheckPrecedneceTables                                     */
  /* purpose:                                                             */
  ...
  {
    if ( linkPrecedenceTable[translateLinkToInt(aLink)][translateLinkToInt(bLink)]==1 )
      return bLink;
    else
      return aLink;
  }
  ...
  public Instance checkPredenceBetweenInstances(Instance aInstance,Instance bInstance)
  {
    ...
    if (aInstance instanceof LinkInstance )
      return checkPrecedenceBetweenLinks((LinkInstance)aInstance,(LinkInstance)bInstance);
    else
      return checkPrecedenceBetweenRelations(aInstance,bInstance);
  }
  /************************************************************************/
  ...
  {
    if (translateRelationToInt(aRelation) > translateRelationToInt(bRelation))
      return bRelation;
    else
      return aRelation;
  }
  ...
  {
    return (IXLinkInstance)checkPrecedenceBetweenLinks((LinkInstance)aLink,(LinkInstance)bLink);
  }
}