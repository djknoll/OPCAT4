...
public class ObjectInZoomingSentenceSetTypeImpl implements extensionTools.opl2.generated.ObjectInZoomingSentenceSetType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_ObjectInZoomingSentence instanceof javax.xml.bind.Element) {
            context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ObjectInZoomingSentence));
        } else {
            context.startElement("", "ObjectInZoomingSentence");
            context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _ObjectInZoomingSentence));
            ...
            switch (state) {
                ...
                case  1 :
                    if (("" == ___uri)&&("ObjectName" == ___local)) {
                        _ObjectInZoomingSentence = ((extensionTools.opl2.generated.impl.ObjectInZoomingSentenceTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ObjectInZoomingSentenceTypeImpl.class), 2, ___uri, ___local, __atts));
                        return ;
                    }
                    break;
            }
