...
public class GeneralEventSentenceTypeImpl implements extensionTools.opl2.generated.GeneralEventSentenceType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
    ...
    public boolean isIsObjectWithStates() {
        return _IsObjectWithStates;
    }

    public void setIsObjectWithStates(boolean value) {
        _IsObjectWithStates = value;
        has_IsObjectWithStates = true;
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        context.endAttributes();
        try {
            context.text(javax.xml.bind.DatatypeConverter.printBoolean(((boolean) _IsObjectWithStates)));
        } catch (java.lang.Exception e) {
            com.sun.xml.bind.marshaller.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
            ...
            throws com.sun.xml.bind.unmarshaller.UnreportedException
        {
            switch (state) {
                ...
                case  15 :
                    ...
                    break;
                case  3 :
                    if (("" == ___uri)&&("IsObjectWithStates" == ___local)) {
                        context.pushAttributes(__atts);
                        state = 6;
                        return ;
                    }
            ...
            throws com.sun.xml.bind.unmarshaller.UnreportedException
        {
            try {
                switch (state) {
                    case  6 :
                        try {
                            _IsObjectWithStates = javax.xml.bind.DatatypeConverter.parseBoolean(com.sun.xml.bind.WhiteSpaceProcessor.collapse(value));
                            has_IsObjectWithStates = true;
                        } catch (java.lang.Exception e) {
