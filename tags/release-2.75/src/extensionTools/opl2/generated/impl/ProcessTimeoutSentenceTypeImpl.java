...
public class ProcessTimeoutSentenceTypeImpl implements extensionTools.opl2.generated.ProcessTimeoutSentenceType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        int idx7 = 0;
        final int len7 = _PathLabel.size();
        int idx8 = 0;
        final int len8 = _TriggeredProcess.size();
        ...
        while (idx8 != len8) {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) _TriggeredProcess.get(idx8 ++)));
            } catch (java.lang.Exception e) {
                com.sun.xml.bind.marshaller.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        ...
        while (idx7 != len7) {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) _PathLabel.get(idx7 ++)));
            } catch (java.lang.Exception e) {
                com.sun.xml.bind.marshaller.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
            ...
            switch (state) {
                case  16 :
                    if (("" == ___uri)&&("TimeValue" == ___local)) {
                        _MaxTimeoutValue = ((extensionTools.opl2.generated.impl.MaxTimeoutValueTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MaxTimeoutValueTypeImpl.class), 17, ___uri, ___local, __atts));
                        return ;
                    }
                    break;
                case  3 :
                ...
                case  19 :
                    if (("" == ___uri)&&("TimeValue" == ___local)) {
                        _MaxReactionTime = ((extensionTools.opl2.generated.impl.MaxReactionTimeTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MaxReactionTimeTypeImpl.class), 20, ___uri, ___local, __atts));
                        return ;
                    }
                    break;
                case  14 :
                    if (("" == ___uri)&&("TimeValue" == ___local)) {
                        _MinReactionTime = ((extensionTools.opl2.generated.impl.MinReactionTimeTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.MinReactionTimeTypeImpl.class), 15, ___uri, ___local, __atts));
                        return ;
                    }
                    break;
                case  0 :
