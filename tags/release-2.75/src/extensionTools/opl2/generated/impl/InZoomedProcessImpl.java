            ...
            switch (state) {
                ...
                case  1 :
                    if (("" == ___uri)&&("ProcessName" == ___local)) {
                        spawnSuperClassFromEnterElement((((extensionTools.opl2.generated.impl.InZoomedProcessTypeImpl)extensionTools.opl2.generated.impl.InZoomedProcessImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, __atts);
                        return ;
                    }
                    break;
            }
