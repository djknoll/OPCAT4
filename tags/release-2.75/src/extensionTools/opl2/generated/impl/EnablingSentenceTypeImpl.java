...
public class EnablingSentenceTypeImpl implements extensionTools.opl2.generated.EnablingSentenceType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{

    protected java.lang.String _ProcessName;
    protected com.sun.xml.bind.util.ListImpl _EnablingClause = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
    ...
    {
        int idx2 = 0;
        final int len2 = _EnablingClause.size();
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            if (_EnablingClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _EnablingClause.get(idx2 ++)));
            } else {
                context.startElement("", "EnablingClause");
                int idx_3 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _EnablingClause.get(idx_3 ++)));
                context.endAttributes();
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _EnablingClause.get(idx2 ++)));
                context.endElement();
            }
            ...
            switch (state) {
                ...
                case  6 :
                    if (("" == ___uri)&&("MinimalCardinality" == ___local)) {
                        _EnablingClause.add(((extensionTools.opl2.generated.impl.EnablingClauseTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.EnablingClauseTypeImpl.class), 7, ___uri, ___local, __atts)));
                        return ;
                    }
                    break;
                case  3 :
            ...
            switch (state) {
                ...
                case  6 :
                    if (("" == ___uri)&&("subjectExhibitionFatherRole" == ___local)) {
                        _EnablingClause.add(((extensionTools.opl2.generated.impl.EnablingClauseTypeImpl) spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.EnablingClauseTypeImpl.class), 7, ___uri, ___local)));
                        return ;
                    }
