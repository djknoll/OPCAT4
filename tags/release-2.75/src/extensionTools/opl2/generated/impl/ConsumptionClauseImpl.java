            ...
            switch (state) {
                case  1 :
                    if (("" == ___uri)&&("MinimalCardinality" == ___local)) {
                        spawnSuperClassFromEnterElement((((extensionTools.opl2.generated.impl.ConsumptionClauseTypeImpl)extensionTools.opl2.generated.impl.ConsumptionClauseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, __atts);
                        return ;
                    }
                    break;
                case  0 :
                    if (("" == ___uri)&&("ConsumptionClause" == ___local)) {
            ...
            switch (state) {
                case  1 :
                    if (("" == ___uri)&&("subjectExhibitionFatherRole" == ___local)) {
                        spawnSuperClassFromEnterAttribute((((extensionTools.opl2.generated.impl.ConsumptionClauseTypeImpl)extensionTools.opl2.generated.impl.ConsumptionClauseImpl.this).new Unmarshaller(context)), 2, ___uri, ___local);
                        return ;
                    }
