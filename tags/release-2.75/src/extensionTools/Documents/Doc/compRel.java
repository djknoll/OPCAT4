 ...
 */
  ...
  String name1 = mySys.getISystemStructure().getIEntry(io1.getSourceId()).getName();
  String name2 = mySys.getISystemStructure().getIEntry(io2.getSourceId()).getName();
  String name11 = mySys.getISystemStructure().getIEntry(io1.getDestinationId()).getName();
  String name22 = mySys.getISystemStructure().getIEntry(io2.getDestinationId()).getName();
