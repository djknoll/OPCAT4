 ...
 */
  private void dest(){
    ...
    dest4=dest4+200;
    destSeq=destSeq+350;
    if((dest1>8000)||(dest2>8000)||(dest3>8000)||(dest4>8000)||(destSeq>8000))
      initialize_dest();
    return;
  }
  ...
  try{
    ...
    Vector OpdInZoomed=new Vector(2,2);
    ...
    Vector StateCompositePrint=new Vector(1,1);
    ...
    Vector restObjVec = new Vector(4,2);
    //-----------------------------------------------------------
    temp = "<!--  ==============   [Model] ====================   -->\n";
    file.write(temp.getBytes());
    String str = mySys.getName();
    ...
    if ((opA==1)||( (opA==2)&&(!vecA.isEmpty()) ) )//called in case activity or statechart requested
    ...
    while (diagramElementsEnum.hasMoreElements()) {
      dest();
      tempId=(String)diagramElementsEnum.nextElement();
      temp = "<UML:DiagramElement xmi.id =\"XX."+tempId+"\" geometry =\""+dest1+", "+dest2+", "+dest3+", "+dest4+",\" style = \"Association:Font.Blue= 0,Font.Green= 0,Font.Red= 0,Font.FaceName=Arial,Font.Size= 10,Font.Bold=0,Font.Italic=0,Font.Strikethrough=0,Font.Underline=0,LineColor.Blue= 51,LineColor.Green= 0,LineColor.Red= 153, \" subject = \"G."+tempId+"\" /> \n";
      file.write(temp.getBytes());
    }
    ...
    while (diagramElementsEnum.hasMoreElements()) {
      dest();
      tempId=(String)diagramElementsEnum.nextElement();
      temp = "<UML:DiagramElement xmi.id = \"XX."+tempId+"\" geometry =\""+dest1+", "+dest2+", "+dest3+", "+dest4+",\" style = \"Role\" subject = \"G."+tempId+"\" />\n";
      file.write(temp.getBytes());
    }
    ...
    while (diagramElementsEnum.hasMoreElements()) {
      dest();
      tempId=(String)diagramElementsEnum.nextElement();
      temp = "<UML:DiagramElement xmi.id = \"XX."+tempId+"\" geometry = \""+dest1+", "+dest2+", "+dest3+", "+dest4+",\" style = \"Inheritance\" subject = \"G."+tempId+"\" />\n";
      file.write(temp.getBytes());
    }
    ...
    while (diagramElementsEnum.hasMoreElements()) {
      dest();
      tempId=(String)diagramElementsEnum.nextElement();
      temp = "<UML:DiagramElement geometry=\""+dest1+", "+dest2+", "+dest3+", "+dest4+",\" style=\"FillColor.Blue= 204,FillColor.Green= 255,FillColor.Red= 255,FillColor.Transparent=1,Font.Blue= 0,Font.Green= 0,Font.Red= 0,Font.FaceName=Arial,Font.Size= 10,Font.Bold=0,Font.Italic=0,Font.Strikethrough=0,Font.Underline=0,LineColor.Blue= 51,LineColor.Green= 0,LineColor.Red= 153,\" subject=\"S."+tempId+"\" />\n";
      file.write(temp.getBytes());
    }
    ...
    while (diagramElementsEnum.hasMoreElements()) {
      ...
      file.write(temp.getBytes());
      dest();
      temp = "<UML:DiagramElement xmi.id=\"XX."+tempId+".1\" geometry=\""+dest1+", "+dest2+", "+dest3+", "+dest4+",\" style=\"Role\" subject=\"G."+tempId+".1\" />\n";
      file.write(temp.getBytes());
      dest();
      temp = "<UML:DiagramElement xmi.id=\"XX."+tempId+".2\" geometry=\""+dest1+", "+dest2+", "+dest3+", "+dest4+",\" style=\"Role\" subject=\"G."+tempId+".2\" />\n";
      file.write(temp.getBytes());
    }
    ...
    while (diagramElementsEnum.hasMoreElements()) {
      ...
      dest();
      temp="<UML:DiagramElement xmi.id=\"XX."+id+"\" geometry=\""+dest1+", "+dest2+", "+dest3+", "+dest4+",\" style=\"FillColor.Blue= 204,FillColor.Green= 255,FillColor.Red= 255,FillColor.Transparent=1,Font.Blue= 0,Font.Green= 0,Font.Red= 0,Font.FaceName=Arial,Font.Size= 10,Font.Bold=0,Font.Italic=0,Font.Strikethrough=0,Font.Underline=0,LineColor.Blue= 51,LineColor.Green= 0,LineColor.Red= 153,\" subject=\"G."+id+"\" /> ";
      file.write(temp.getBytes());
     }
...
//---------------------------------PRINTOUTS OF ACTIVITY DIAGRAM ----------------------------------
    ...
    while (actDiagrams.hasMoreElements()){
      ...
      ownerId=isActSubDiagram(diagramId,vecA);
      ...
      while (actInitials.hasMoreElements()){
        ...
        if (tempPrintStructure.getDiagramId().compareTo(diagramId)==0){
          temp="<UML:DiagramElement xmi.id=\"XX.a"+tempPrintStructure.getElementId()+"\" geometry=\"816,"+dest2+", 60, 60,\" style=\"FillColor.Blue= 255,FillColor.Green= 255,FillColor.Red= 255,FillColor.Transparent=0,Font.Blue= 0,Font.Green= 0,Font.Red= 0,Font.FaceName=Arial,Font.Size= 10,Font.Bold=0,Font.Italic=0,Font.Strikethrough=0,Font.Underline=0,LineColor.Blue= 51,LineColor.Green= 0,LineColor.Red= 153,\" subject=\"G."+tempPrintStructure.getElementId()+"\" />";
      ...
      while (actForks.hasMoreElements()){
        ...
        if (tempPrintStructure.getDiagramId().compareTo(diagramId)==0){
          dest();
          temp="<UML:DiagramElement xmi.id=\"XX.a"+tempPrintStructure.getElementId()+"\" geometry=\" 864,"+dest2+", 992, 18,\" style=\"SyncItem, Horizontal=1,\" subject=\"G."+tempPrintStructure.getElementId()+"\" />";
      ...
      while (actActivities.hasMoreElements()){
        ...
        if (tempPrintStructure.getDiagramId().compareTo(diagramId)==0){
          dest();
          temp="<UML:DiagramElement xmi.id=\"XX.a"+tempPrintStructure.getElementId()+"\" geometry=\" 736,"+dest2+", 411, 124,\" style=\"FillColor.Blue= 204,FillColor.Green= 255,FillColor.Red= 255,FillColor.Transparent=1,Font.Blue= 0,Font.Green= 0,Font.Red= 0,Font.FaceName=Arial,Font.Size= 10,Font.Bold=0,Font.Italic=0,Font.Strikethrough=0,Font.Underline=0,LineColor.Blue= 51,LineColor.Green= 0,LineColor.Red= 153,\" subject=\"G."+tempPrintStructure.getElementId()+".5\" />";
     ...
     //joins
      ...
      while (actFinals.hasMoreElements()){
        ...
        if (tempPrintStructure.getDiagramId().compareTo(diagramId)==0){
          dest();
          temp="<UML:DiagramElement xmi.id=\"XX.a"+tempPrintStructure.getElementId()+"\" geometry=\"800,"+dest2+", 84, 84,\" style=\"FillColor.Blue= 255,FillColor.Green= 255,FillColor.Red= 255,FillColor.Transparent=0,Font.Blue= 0,Font.Green= 0,Font.Red= 0,Font.FaceName=Arial,Font.Size= 10,Font.Bold=0,Font.Italic=0,Font.Strikethrough=0,Font.Underline=0,LineColor.Blue= 51,LineColor.Green= 0,LineColor.Red= 153,\" subject=\"G."+tempPrintStructure.getElementId()+"\" />";
    ...
    if (opSt==1){
      ...
      while (e.hasMoreElements()){
        ...
        while ( (e1.hasMoreElements()) && (flag==0) ){
          ...
          if (tempId!="-1"){
            dest();
            temp="<UML:DiagramElement xmi.id=\"XX."+tempId+"\" geometry=\""+dest1+", "+dest2+", 300, 134,\" style=\"FillColor.Blue= 204,FillColor.Green= 255,FillColor.Red= 255,FillColor.Transparent=1,Font.Blue= 0,Font.Green= 0,Font.Red= 0,Font.FaceName=Arial,Font.Size= 10,Font.Bold=0,Font.Italic=0,Font.Strikethrough=0,Font.Underline=0,LineColor.Blue= 51,LineColor.Green= 0,LineColor.Red= 153,\" subject=\"G."+tempId+"\" /> ";
            file.write(temp.getBytes());
          }
          else flag=1;
        }
...
//---------------------------------PRINTOUTS OF Sequence DIAGRAM -------------------------------------------
    ...
    Enumeration assEnum;
    String diagIdC="",diagIdA="",nameC="",restId="",logViewId;
    Object abstrObj;
    IObjectEntry obj;
    int sqn;
    boolean M1,M2;
    ...
    while(clsRoleEnum.hasMoreElements()){
        ...
        while ((!M1)&&(clsRoleEnum.hasMoreElements())){
          ...
          if (tempId=="-1")
            ...
            dest();
            temp="<UML:DiagramElement xmi.id=\"XX."+tempId+"\" geometry=\""+destSeq+", 224, 300, 118,\" style=\"FillColor.Blue= 204,FillColor.Green= 255,FillColor.Red= 255,FillColor.Transparent=1,Font.Blue= 0,Font.Green= 0,Font.Red= 0,Font.FaceName=Arial,Font.Size= 10,Font.Bold=0,Font.Italic=0,Font.Strikethrough=0,Font.Underline=1,LineColor.Blue= 51,LineColor.Green= 0,LineColor.Red= 153,\" subject=\"G."+tempId+"\" /> ";
            file.write(temp.getBytes());
          }
        }
          ...
          if (diagIdA.compareTo(diagIdC)==0){
            while(!M1){
              ...
              if (tempId=="-1")
                ...
                sqn++;
                dest();
                temp="<UML:DiagramElement xmi.id=\"XX."+tempId+"\" geometry=\""+destSeq+", 324, 12, 52,\" style=\"Message, SQN= "+sqn+",\" subject=\"G."+tempId+"\" /> ";
                file.write(temp.getBytes());
              }//end else
            }
          }
...
//---------------------------------PRINTOUTS OF Sequence DIAGRAM end------------------------------------
  ...
  private String isActSubDiagram(String diagramId,Vector vecA){
    Enumeration enum = vecA.elements();
    IProcessEntry proc;
    String temp="";
