...
//		}
	...
	{
		return (IOpd)parentOpd;
	}

	public IXOpd getParentIXOpd()
	{
		return (IXOpd)parentOpd;
	}
  ...
  public long _getFreeEntityInOpdEntry()
	...
	public int print(Graphics g, PageFormat pf, int pi) throws PrinterException
	{
		...
		// save/restore transform scope at
			...
			Color objBgColor = (Color)myProject.getConfiguration().getProperty("BackgroundColor");
		...
		printHeader(g2, psd, (int)xTr, (int)yTr, (int)printPageWidth, myFont);
		printFooter(g2, psd, pi, (int)xTr, (int)yTr + printPageHeight, (int)printPageWidth, myFont);
...
//		}
	...
	{
		return (IThingEntry)mainEntry;
	}

	public IXThingEntry getMainIXEntry()
	{
		return (IXThingEntry)mainEntry;
	}
	...
	{
		return (IThingInstance)mainInstance;
	}

	public IXThingInstance getMainIXInstance()
	{
		return (IXThingInstance)mainInstance;
	}
...
//        ImageIcon ic = new ImageIcon(myImage);
	...
	public void selectAll()
	{
      ...
      {
        return (Instance)inhertRelationsOverReusedThings.get((ThingInstance)source);
      }
      /**
       *
       * @param aInstance
