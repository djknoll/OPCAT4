...
public class OpdInstantination extends OpdFundamentalRelation
{
	...
	public void paintComponent(Graphics g)
	{
		...
		double centerY = selOffset+ ((double)(getHeight()-dSelOffset))*2/3;
		double size = ((double)(getWidth()-dSelOffset))/3;
	...
	{
		RelationPropertiesDialog rd = new RelationPropertiesDialog(graphicalEntry, "Classification-Instantiation", false);
		rd.showDialog();
	}
