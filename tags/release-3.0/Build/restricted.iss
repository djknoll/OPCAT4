...
Name: {userdocs}\OPCAT Projects; Flags: uninsneveruninstall
...
Root: HKLM; Subkey: SYSTEM\CurrentControlSet\Control\Session Manager\Environment; ValueType: string; ValueName: OPCAT_BACKUP_HOME; ValueData: {app}\backup; Flags: uninsdeletevalue
Root: HKLM; Subkey: SYSTEM\CurrentControlSet\Control\Session Manager\Environment; ValueType: string; ValueName: OPCAT_COLORS_HOME; ValueData: {app}; Flags: uninsdeletevalue
Root: HKLM; Subkey: SYSTEM\CurrentControlSet\Control\Session Manager\Environment; ValueType: string; ValueName: OPCAT_PROJECTS_HOME; ValueData: {userdocs}\OPCAT Projects; Flags: uninsdeletevalue
