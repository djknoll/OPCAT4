...
public class OplColorScheme {
	...
	this.putAttribute(NOTE_STYLE, new ColorAttribute("Notes", Color.red,
		false, false, false));
	this.putAttribute(PROMPT_STYLE, new ColorAttribute("Prompt", blueColor,
		false, false, false));
	this.putAttribute(MSG_STYLE, new ColorAttribute("Message", greenColor,
		false, false, false));
