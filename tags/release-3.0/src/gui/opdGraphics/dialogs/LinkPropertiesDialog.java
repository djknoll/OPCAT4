 ...
 */
public class LinkPropertiesDialog extends JDialog implements ComponentListener {
    /**
         * 
         */
    ...
    /**
         ...
         *                window
         * @param <code>opdLink</code> -- the one of the following OPD links
         *                to show properies for, the link is a subclass of <a
         *                href = "AroundDragger.html"><code>AroundDragger</code></a>
         *                <ul>
         ...
         * @param <code>sName</code> -- The name of the source OPD component,
         *                OPD Object
         * @param <code>dName</code> -- The name of the destination OPD
         *                component, OPD Object
         */
	...
	if (myEntry.getLinkType() == OpcatConstants.EFFECT_LINK) {
	    ...
	    this.myEntry.setResourceConsumptionAccumolated(accumolate.isSelected()) ; 
	}
