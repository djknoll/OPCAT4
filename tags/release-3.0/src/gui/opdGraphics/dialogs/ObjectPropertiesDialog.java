 ...
 */
public class ObjectPropertiesDialog extends JDialog implements
	ComponentListener {
    ...
    private JTextArea name, description, url, generaldescription /*
                                                                         * ,
                                                                         * type
                                                                         */;
    ...
    /**
         * Constructor:
         * 
         * @param <code>parent</code> -- parent frame, Opcat2 application
         ...
         *                <code>projectStructure.ThingEntry</code> class,
         *                entry of this OPD Object in project dynamic structure.
         * @see <a href = "ThingEntry.html"><code>ThingEntry</code></a>
	...
	if ((this.showTabs & BaseGraphicComponent.SHOW_2) != 0) {
	    /*
                 * TODO: this is the keys and indices tab. i removed this as it
                 * has no real porpose and use. we can add this later when we
                 * create a real DB creation tools. raanan
                 * 
                 */
	...
	if ((this.showTabs & BaseGraphicComponent.SHOW_2) != 0) {
	    ...
	    /*
                 * TODO: this should be returned to keys description when key
                 * are returned
                 */
	...
	public void actionPerformed(ActionEvent e) {
	    LibraryLocationDialog addLocation = new LibraryLocationDialog( Opcat2.getFrame());
