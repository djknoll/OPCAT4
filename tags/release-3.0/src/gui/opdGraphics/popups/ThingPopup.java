...
public class ThingPopup extends DefaultPopup {
	...
	completeLinksActionWithAddMissing = new CompleteLinksForConnectionEdgeEntry(
		...
		(ConnectionEdgeEntry) inst.getEntry(), true);
	completeLinksActionWithOutAddMissing = new CompleteLinksForConnectionEdgeEntry(
		"Do Not Add Missing Things", StandardImages.COMPLETE_LINKS_NO_THING,
		(ConnectionEdgeEntry) inst.getEntry(), false);
	...
	if (myEntry instanceof ObjectEntry) {
	    ...
	    if (((OpmObject) myEntry.getLogicalEntity()).getMesurementUnit()
    ...
    Action createViewAction = new AbstractAction("Create View", StandardImages.EMPTY) {
    ...
    Action alignTopAction = new AbstractAction("Top", StandardImages.ALIGN_VERTICAL_TOP) {
    ...
    Action alignBottomAction = new AbstractAction("Bottom", StandardImages.ALIGN_VERTICAL_BOTTOM) {
    ...
    Action alignCenterVerticallyAction = new AbstractAction("Center Vertically", StandardImages.ALIGN_VERTICAL_CENTER) {
    ...
    Action alignAsTreeAction = new AbstractAction("As Tree", StandardImages.EMPTY) {
    ...
    Action alignVertically = new AbstractAction("Vertically", StandardImages.EMPTY) {
