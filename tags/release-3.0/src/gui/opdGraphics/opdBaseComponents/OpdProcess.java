...
public class OpdProcess extends OpdThing {
    ...
    /**
         * <p>
         * Constructs <code>OpdProcess</code> object and initialize all
         * defaults.
         * </p>
         ...
         *                is added to.
         * @param <code>pEntry ThingEntry</code>, the entry of the thing,
         *                this <code>OpdThing</code> represents graphicaly.
    ...
    /**
         ...
         * <p>
         * Updates changed Process properties not only in this OpdProcess, but
         * in <a href = "../opmEntities/OpmProcess.html"><code>OpmProcess</code></a>
    ...
    /**
         ...
         * and y are defined to be relative to the coordinate system of this
         * component.
         * </p>
         * <p>
