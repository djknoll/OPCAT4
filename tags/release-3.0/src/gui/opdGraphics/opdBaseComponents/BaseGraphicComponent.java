...
import gui.Opcat2;
import gui.metaDataProject.MetaDataColors;
...
public abstract class BaseGraphicComponent extends JLayeredPane implements
    ...
    /**
         * The font, if this component contains some text information, like
         * name, it will be drawn using this font
         */
    ...
    /*
         * AroundDraggers or its subclasses of the links or relations connected
         * to this component
         */
    ...
    /**
         ...
         * <code>NOT_IN_BOREDR</code> when thecomponent is drawn with shadow
         * there are areas that not in border niether in center
         */
    ...
    /**
         ...
         * @param <code>pOpdId long</code>, uniqe identifier of the
    ...
    /**
         ...
         * graphically capable to contain another object (for zooming in
         * operation).
         */
    ...
    /**
         * Repaint all lines of the OPD links and OPD relations connected to
         * this component
         */
    ...
    /**
         ...
         * Behavior depends on state of <a href =
         * "../opdProject.OpdStateMachine.html"><code>OpdStateMachine</code></a>
         * state. Also sets the mouse cursor. The method decides if the element
         * is to be selected, moved or resized.
         */
    ...
    /**
         ...
         * "../opdProject.OpdStateMachine.html"><code>OpdStateMachine</code></a>
         * state. The method might resize the element or move it, according to
         * the <code>resize</code> variable state. The method contains a
         * disabled feature, in which things which reside within the zoomed-in
         * thing, are resized along with it. Whenever an element get dragged, it
         * is first of all pressed, using the <code>mousePressed</code>
         * method.
         * 
    ...
    /**
         * Paints the component. Abstract method, defines interface for
         * subclasses
         */
    ...
    /**
         ...
         * This method is invoked when user performs double click on the
    ...
    /**
         ...
         * area it resizes the component. Abstract method, defines interface for
         * subclasses.
         */
    public abstract boolean inResize(int pX, int pY);

    /**
         * Test if the point in moving area i.e. if user drags mouse in this
         * area it moves the component. Abstract method, defines interface for
         * subclasses
         */
    public abstract boolean inMove(int pX, int pY);

    /**
         * Returns one of constants which determines on which border point (pX,
         * pY) lays. Abstract method, defines interface for subclasses.
         */
    ...
    /**
         ...
         * component was selected, there is high probability that something in
