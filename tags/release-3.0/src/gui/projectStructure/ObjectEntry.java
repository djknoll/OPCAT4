...
public class ObjectEntry extends ThingEntry implements IObjectEntry,
    ...
    /**
         * Creates ObjectEntry that holds all information about specified
         * pObject.
         * 
         * @param pObject
    ...
    /**
         * Returns Enumeration which contains all states belonging to this
         * object. Use the Enumeration methods on the returned object to fetch
         * the OpmState sequentially
         */
    ...
    /**
         * Returns Enumeration of StateEntry which contains all states belonging
         * to this object. Use the Enumeration methods on the returned object to
         * fetch the StateEntry sequentially
         */
    ...
    /**
         * Adds newState to data structure containing all states belonging to
         * this OPM object
         * 
         */
    ...
    /**
         * Removes OpmState with specified stateID from data structure
         * containing all states belonging to this OPM object
         * 
         */
    ...
    /**
         * Removes state from data structure containing all states belonging to
         * this OPM object
         * 
         */
    ...
    /**
         * Returns OpmState with specified stateID from data structure
         * containing all states belonging to this OPM object. null is returned
    ...
    /**
         ...
         * Enumeration methods on the returned object to fetch the
