...
public class ConnectionEdgeEntry extends Entry implements IConnectionEdgeEntry,
    ...
    /**
         * Creates ConnectionEdgeEntry that holds all information about
         * specified pEdge.
         * 
         * @param pEdge
    ...
    /**
         * This method adds pRelation to the data structure holding all
         * structural relations in which this ConnectionEdgeEntry participates
         * as source.
         * 
         */
    ...
    /**
         * This method adds pLink to the data structure holding all procedural
         * links in which this ConnectionEdgeEntry participates as source.
         * 
         */
    ...
    /**
         ...
         * participates as destination and this ConnectionEdgeEntry participates
         * as source. null is returned if there is no such OpmProceduralLink in
         * data structure.
         */
    ...
    /**
         * This method adds pLink to the data structure holding all procedural
         * links in which this ConnectionEdgeEntry participates as destination.
         * 
         */
    ...
    /**
         ...
         * destination. null is returned if there is no such OpmProceduralLink
         * in data structure.
         */
    ...
    /**
         ...
         * ConnectionEdgeEntry paricipates as source. Use the Enumeration
    ...
    /**
         * Returns Enumeration of IRelationEntry - all srtructural relations
         * having this IConnectionEdgeEntry as source. Use the Enumeration
         * methods on the returned object to fetch the IRelationEntry
         * sequentially
         */
    ...
    /**
         * Returns Enumeration of RelationEntry - all structural relations
         * having this ConnectionEdgeEntry as destination. Use the Enumeration
         * methods on the returned object to fetch the RelationEntry
         * sequentially
         */
    ...
    /**
         * Returns Enumeration of LinkEntry - all links having this
         * ConnectionEdgeEntry as destination. Use the Enumeration methods on
         * the returned object to fetch the LinkEntry sequentially
         */
    ...
    /**
         * Returns an enumeration of OpmEntity (all relations and links) in
         * which this ConnectionEdgeEntry paricipates. Use the Enumeration
         * methods on the returned object to fetch the OpmStructuralRelation
         * sequentially
         * 
         */
	...
	while (linksEnum.hasMoreElements()) {
		...
		if (addMisingThings) {
			...
			otherInstance.getOpd().getSelection().addSelection(
				objectIns, true);
			myProject._copy(otherInstance.getOpd(), opd, 1, 1, opd
				.getDrawingArea(), true);
		    } else {
			otherInstance.getOpd().getSelection().addSelection(
				otherInstance, true);
