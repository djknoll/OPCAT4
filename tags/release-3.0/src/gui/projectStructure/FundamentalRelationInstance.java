...
public class FundamentalRelationInstance extends Instance implements
    ...
    /**
         ...
         * 
         * @param pSource
         *                OpdConnectionEdge that represents the source
         *                graphically.
         * @param pRelation
         *                OpdFundamentalRelation representing graphically this
         *                fundamental relation
         * @param pDestination
         *                OpdConnectionEdge that represents the destination
         *                graphically.
         * @param pDestinationDragger
         *                AroundDragger that connected to destination.
         * @param pLine
         *                OpdLine that connects destination AroundDragger to
         *                "triangle" representing graphically this fundamental
         *                relation.
         * @param myKey
         *                OpdKey - key of graphical instance of this
         *                LinkInstance.
         * @param pLogicalRelation
         *                OpmFundamentalRelation representing this fundamental
         *                relation.
         */
    ...
    /**
         ...
         * IXRelationInstance to which line the link is connected. You can
    ...
    /**
         * Gets destination RelativeConnectionPoint - the point on destination
         * of this IXRelationInstance to which line of this link is connected.
    ...
    /**
         * Sets destination RelativeConnectionPoint - the point on destination
         * of this IXRelationInstance to which line of this link is connected.
         * 
         * @see RelativeConnectionPoint
         */
    ...
    /**
         * Gets IXConnectionEdgeInstance which is source of this
         * IXRelationInstance.
         */
    ...
    /**
         * Gets IConnectionEdgeInstance which is source of this
         * IRelationInstance.
         */
    ...
    /**
         * Returns OpdConnectionEdge that represents the destination
         * graphically.
         * 
         */
    ...
    /**
         * Returns OpmFundamentalRelation that represents this fundamental
         * relation logically.
         * 
         */
