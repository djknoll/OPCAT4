...
public abstract class ThingInstance extends ConnectionEdgeInstance implements
	...
	public IXOpd createUnfoldedOpd(boolean bringRelatedThings, boolean bringRoleRelatedThings) {
		return this.myProject.unfolding(this, bringRelatedThings, bringRelatedThings, true , bringRoleRelatedThings);
	}
