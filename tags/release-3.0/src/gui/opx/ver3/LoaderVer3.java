...
public class LoaderVer3 extends LoaderVer2 {
    ...
    /**
         * Overloads the load method of version 2. Currently, does not provide
         * any functionality.
         * 
         */
    ...
    /**
         * Overloads the system attributes loading, setting the version number
         * of the OPX to <code>myProject</code>.
         * 
    ...
    /**
         * Extends the <code>SystemProperties</code> loading section,
         * augmenting it with <b>MetaLibraries </b> support.
         */
