...
public class SaverVer2 implements SaverI {
    ...
    /**
         ...
         * <code>_appendOpdPropetries</code> in order to render the properties
         * of the actual OPD, and <code>_appendOpdPropetries</code> in order
         * to render the subelements of the OPD.
         * 
         * @param opdNum
         *                The number of OPD
         */
    ...
    /**
         * Renders the OPD subelements, such as tjomgs. fundumental relations
         * etc.
         * 
         * @throws JDOMException
         */
	...
	for (Iterator it = rootList.iterator(); it.hasNext();) {
	    // reuse comment - don't save instances which are from the
                // reused system
