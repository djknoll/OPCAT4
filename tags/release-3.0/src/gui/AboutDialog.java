...
public class AboutDialog extends JDialog {
	...
	private void jbInit() throws Exception {
		...
		this.jTabbedPane1.setBounds(new Rectangle(3, 2, 370, 265));
		this.closeButton.setText("Close");
		this.closeButton.setBounds(new Rectangle(270, 274, 102, 28));
		this.closeButton
				.addActionListener(new AboutDialog_closeButton_actionAdapter(
						this));
		this.jPanel3.setLayout(null);
		this.jLabel13.setBounds(new Rectangle(-2, 0, 368, 238));
		...
		this.jLabel17.setBounds(new Rectangle(20, 39, 200, 32));
		...
		this.jLabel18.setBounds(new Rectangle(20, 70, 200, 32));
		...
		String copyright = "OPCAT Systems. All rights reserved (c) 2005-2007";
		...
		this.jScrollPane1.setBounds(new Rectangle(14, 9, 342, 215));
