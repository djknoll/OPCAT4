 ...
 */
// -----------------------------------------------------------------
public abstract class OpmEntity extends MetaDataAbstractItem {

    /**
         * A roles manager that manage {@link Role} objects for the current
         * <code>OpmThing</code>. The manager is set to <code>null</code>
         * and is initialized only if called by the <code>getRolesManager</code>
         * method.
         * 
         * @author Eran Toch
         */
    ...
    private boolean enviromental = false; // true if enviromental, false if system

    private boolean physical = false; // true if enviromental, false if system

    /**
         * Creates an OpmEntity with specified id and name. Id of created
         * OpmEntity must be unique in OPCAT system
         * 
         * @param id
         *                entity id
         * @param name
    ...
    /**
         ...
         *         <p>
         *         The following code demonstrates how to print the role
         *         reference:
         *         <p>
         *         <code>
    ...
    /**
         * Returns the full graphical representation of the roles, including
         * free text <code>String</code> roles and meta-libraries based roles.
         * 
         * @author Eran Toch
         * @return
         */
    ...
    /**
         * Returns the full graphical representation of the roles which library
         * is of a given type (policy, not policy) , including free text
