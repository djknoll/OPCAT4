...
public class Validator implements OpcatExtensionTool {
	...
	public JPanel execute(ISystem opcatSystem, Opcat2 myOpcat2, JFrame parent) {
		...
		return new ValidatorPanel(opcatSystem, myOpcat2, this.algorithm,columnNames,  parent);
	}
	...
	public JPanel execute(ISystem opcatSystem) {
		...
		columnNames.add("Thing");
		columnNames.add("Warning");
		return new ValidatorPanel(opcatSystem, null,  this.algorithm, columnNames , null);
	}
	...
	public JDialog validationResults(ISystem opcatSystem, Opcat2 myOpcat2, JFrame parent) {
		...
		dialog.getContentPane().add(
			new ValidatorPanel(opcatSystem, myOpcat2, this.algorithm, columnNames, parent),
			BorderLayout.CENTER);
		return dialog;
	}
