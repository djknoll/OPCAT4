...
public class TestingSettings extends Object {
  ...
  public static boolean MIN_TIME__PROCESS_DURATION = false ; 
  ...
  public static boolean SHOW_LIFE_SPAN = false ; 
  public static boolean  STOP_AT_AGENT = true ; 
  ...
  public static boolean RANDOM_PROCESS_DURATION = false ; 
  ...
  public static void loadSettings(TestingSettings newSettings)  {
    ...
    SHOW_LIFE_SPAN = TestingSettings.SHOW_LIFE_SPAN ; 
    STOP_AT_AGENT = TestingSettings.STOP_AT_AGENT ; 
    MIN_TIME__PROCESS_DURATION = TestingSettings.MIN_TIME__PROCESS_DURATION ; 
  }
}