...
class TestingEvent {
 ...
 // if this indicator is true the system will try to activate the event until it will succeed
  ...
  public void setEventType(int type) {
    if (type == TestingSettings.ACTIVATION_EVENT) {
      this.eventType = TestingSettings.ACTIVATION_EVENT;
    }
    else  {
      this.eventType = TestingSettings.TERMINATION_EVENT;
    }
  }
  ...
  public void setExecutionId() {
    this.executionId = ++TestingSettings.LAST_EXECUTION_ID;
  }
