...
public class OpdBiDirectionalRelation extends OpdGeneralRelation
{
	...
	{
		GeneralBiDirRelationPropertiesDialog gd = new GeneralBiDirRelationPropertiesDialog((OpmBiDirectionalRelation)getEntity(), new OpdKey(getOpdId(), getEntityInOpdId()), myProject);
		gd.show();
	}
}
