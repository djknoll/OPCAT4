 ...
 */
	...
	public DeleteDialog(LoadParameters parameters)
	{
		...
		{
			loadTable.setValueAt(new ProjectNameId1(param.getProjectName(i), i), i, 0);
			loadTable.setValueAt(param.getProjectCreator(i), i, 1);
			loadTable.setValueAt(param.getCreationDate(i), i, 2);
		}
		loadButton = new JButton("Delete");
		cancelButton = new JButton("Cancel");
		loadButton.addActionListener(new DeleteListener());
	...
	class DeleteListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			...
			{
				ProjectNameId1 pnid;
				pnid = (ProjectNameId1)loadTable.getValueAt(loadTable.getSelectedRow(),0);
