...
public class AboutDialog extends JDialog {
	private static String htmlText = "<html><br>"
			...
			"<font color='navy' face='Tahoma' size=-1><b>Integration:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Yevgeny(Zhenya) Yaroker</li>"
			+ "<li>Valeriya Perelman</li>"
			+ "<li>Eran Toch</li>"
			+ "</ul><font>"
			+

			"<font color='navy' face='Tahoma' size=-1><b>GUI & Internal Logic:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Stanislav Obydionnov</li>"
			+ "<li>Yevgeny(Zhenya) Yaroker</li>"
			+ "<li>Eran Toch</li>"
			+ "<li>Valeriya Perelman</li>"
			+ "</ul><font>"
			...
			"<font color='navy' face='Tahoma' size=-1><b>OPL Generation:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Valeriya Bodnya</li>"
			+ "<li>Sergey Krutyolkin</li>"
			+ "<li>Irina Rahmatulina</li>"
			+ "<li>Daria Gipsman</li>"
			+ "<li>Yevgeny(Zhenya) Yaroker</li>"
			+ "</ul><font>"
			+

			"<font color='navy' face='Tahoma' size=-1><b>Animation:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Larisa Shmerlin</li>"
			+ "<li>Martin Terreni</li>"
			+ "</ul><font>"
			+

			"<font color='navy' face='Tahoma' size=-1><b>Code Generation:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Valeriya Perelman</li>"
			+ "<li>Sergey Guenender</li>"
			+ "</ul><font>"
			+

			"<font color='navy' face='Tahoma' size=-1><b>OPD from OPL Generation:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Ilana Vekselman</li>"
			+ "<li>Maya Yanovsky</li>"
			+ "<li>Elena Katz</li>"
			+ "<li>Avraham Katz</li>"
			+ "</ul><font>"
			...
			"<font color='navy' face='Tahoma' size=-1><b>UML & Documents Generation:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Olga Tavrovsky</li>" + "<li>Anna Levit</li>"
			+ "<li>Limor Kats</li>" + "<li>Nela Izbinsky</li>" + "</ul><font>" +

			"<font color='navy' face='Tahoma' size=-1><b>OpcaTeam:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Dizza Beimel</li>" + "<li>Lior Galanti</li>"
			+ "<li>Yossi Gozlan</li>" + "</ul><font>" +

			"<font color='navy' face='Tahoma' size=-1><b>Meta-libraries:</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Eran Toch</li>" + "</ul><font>" +

			"<font color='navy' face='Tahoma' size=-1><b>Reuse & System UDDI</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Dror Givoli</li>" + "<li>Roy Ionas</li>" + "</ul><font>" +

			"<font color='navy' face='Tahoma' size=-1><b>Human Input-Output</b><font>"
			+ "<font color='navy' face='Tahoma' size=-1><ul>"
			+ "<li>Ori Meroz</li>" + "<li>Roni Ramon</li>" + "<li>Liat Katzir</li>" +"</ul><font>" +
	...
	private void jbInit() throws Exception {
		...
		jLabel18.setText("Date:  05.09.2005");
