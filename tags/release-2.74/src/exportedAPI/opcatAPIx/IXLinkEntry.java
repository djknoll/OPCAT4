...
/**
 * IXLinkEntry is an interface to logical representation of OPM links.
...
public interface IXLinkEntry extends IXEntry
{
	...
	/**
	* Returns the ID of source IXConnectionEdgeEntry that link connected to.
	* @return the ID of source IXConnectionEdgeEntry
	*/
	public long getSourceId();

	/**
	* Returns the ID of destination IXConnectionEdgeEntry that link connected to.
	...
	* of this IXLinkEntry. This String contains non-negative integer X 7
	...
	* @param minimum link reaction type as string
	*/
	...
	* separation.
	* <strong>Importent</strong>: Legality of given string is not checked when using this method.
	* @param maximum link reaction type as string
	*/
