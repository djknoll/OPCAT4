...
public class ReuseCommand {
    ...
    private Hashtable inhertRelationsOverReusedThings = new Hashtable();

    private LinkedList openReuseAidObjects = new LinkedList();
    ...
    public void commitReuse() throws OpcatException {
        ...
        addReusedOpd(reusedProject.getCurrentOpd(), currentProject
     ...
     */
    protected boolean addReusedOpd(Opd reusedOpd, Opd targetOpd, ThingInstance container, boolean forceContainer) throws OpcatException {
        int x = 0, y = 0; // coordinates for objects/processes at first level
        Instance mainIns = null, generalInstance = null;
        int screenHeight = currentProject.getMainFrame().getHeight();
        ThingEntry myEntry;
        ThingInstance addedInstance = null;
    ...
    protected ObjectInstance addReusedObject(Instance reusedObjectInstance, int x, int y, Opd targetOpd, ThingInstance container) throws OpcatException {
        ...
        ThingInstance reusedThingInstance = (ThingInstance) reusedObjectInstance;
        ThingInstance myThingInstance;
        ...
        try {
            if (existReusedEntry(reusedObjectInstance.getEntry())) {
                Entry fatherEntry = (Entry) reusedEntriesTable
    ...
    protected void addReusedStates(ObjectInstance addedObject, ObjectInstance reusedFrom, Opd targetOpd) {
        ...
        ConnectionEdgeInstance reusedConnection, targetConnection;
        //Opd tOpd =
        // mainComponentsStructure.getOpd(addedObject.getKey().getOpdId());
        Entry addedState;
        Enumeration g;
