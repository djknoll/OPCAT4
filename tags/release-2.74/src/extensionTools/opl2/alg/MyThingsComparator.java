...
public class MyThingsComparator extends MyComparator{
  ...
  public MyThingsComparator(boolean isObjInZooming_,OPLTreeBuilder builder_) {
    isObjInZooming = isObjInZooming_;
    builder = builder_;
  }
  ...
  public int compare(Object o1, Object o2) {
    ...
    if(ent1 instanceof IProcessEntry && ent2 instanceof IProcessEntry){
      IThingInstance i1 = (IThingInstance)builder.getIInstanceByOPD(ent1);
      IThingInstance i2 = (IThingInstance)builder.getIInstanceByOPD(ent2);
      if(i1.getY()<i2.getY())
          return -1;
  ...
  private boolean isFather(IEntry ent1, IEntry ent2){
   java.util.List list = builder.getFathersList(ent2);
