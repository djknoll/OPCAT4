...
public class ProcessAggregationSentenceSetTypeImpl implements extensionTools.opl2.generated.ProcessAggregationSentenceSetType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_ProcessAggregationSentence instanceof javax.xml.bind.Element) {
            context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ProcessAggregationSentence));
        } else {
            context.startElement("", "ProcessAggregationSentence");
            context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _ProcessAggregationSentence));
            ...
            switch (state) {
                ...
                case  1 :
                    if (("" == ___uri)&&("ProcessName" == ___local)) {
                        _ProcessAggregationSentence = ((extensionTools.opl2.generated.impl.ProcessAggregationSentenceTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ProcessAggregationSentenceTypeImpl.class), 2, ___uri, ___local, __atts));
                        return ;
                    }
                    break;
            }
