            ...
            switch (state) {
                case  1 :
                    if (("" == ___uri)&&("ObjectName" == ___local)) {
                        spawnSuperClassFromEnterElement((((extensionTools.opl2.generated.impl.ObjectInZoomingSentenceTypeImpl)extensionTools.opl2.generated.impl.ObjectInZoomingSentenceImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, __atts);
                        return ;
                    }
                    break;
                case  3 :
