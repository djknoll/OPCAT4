...
public class ProcessExhibitionSentenceSetTypeImpl implements extensionTools.opl2.generated.ProcessExhibitionSentenceSetType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
        ...
        throws org.xml.sax.SAXException
    {
        ...
        if (_ProcessExhibitionSentence instanceof javax.xml.bind.Element) {
            context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ProcessExhibitionSentence));
        } else {
            context.startElement("", "ProcessExhibitionSentence");
            context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _ProcessExhibitionSentence));
            ...
            switch (state) {
                ...
                case  1 :
                    if (("" == ___uri)&&("ProcessName" == ___local)) {
                        _ProcessExhibitionSentence = ((extensionTools.opl2.generated.impl.ProcessExhibitionSentenceTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ProcessExhibitionSentenceTypeImpl.class), 2, ___uri, ___local, __atts));
                        return ;
                    }
                    break;
                case  4 :
