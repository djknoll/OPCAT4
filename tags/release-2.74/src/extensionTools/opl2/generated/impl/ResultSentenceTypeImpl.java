...
public class ResultSentenceTypeImpl implements extensionTools.opl2.generated.ResultSentenceType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{

    protected java.lang.String _ProcessName;
    protected com.sun.xml.bind.util.ListImpl _ResultClause = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
    ...
    {
        int idx2 = 0;
        final int len2 = _ResultClause.size();
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            if (_ResultClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ResultClause.get(idx2 ++)));
            } else {
                context.startElement("", "ResultClause");
                int idx_3 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _ResultClause.get(idx_3 ++)));
                context.endAttributes();
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ResultClause.get(idx2 ++)));
                context.endElement();
            }
            ...
            switch (state) {
                ...
                case  6 :
                    if (("" == ___uri)&&("MinimalCardinality" == ___local)) {
                        _ResultClause.add(((extensionTools.opl2.generated.impl.ResultClauseTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ResultClauseTypeImpl.class), 7, ___uri, ___local, __atts)));
                        return ;
                    }
                    break;
            }
            ...
            switch (state) {
                ...
                case  6 :
                    if (("" == ___uri)&&("subjectThingName" == ___local)) {
                        _ResultClause.add(((extensionTools.opl2.generated.impl.ResultClauseTypeImpl) spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.ResultClauseTypeImpl.class), 7, ___uri, ___local)));
                        return ;
                    }
                    if (("" == ___uri)&&("logicalRelation" == ___local)) {
                        _ResultClause.add(((extensionTools.opl2.generated.impl.ResultClauseTypeImpl) spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.ResultClauseTypeImpl.class), 7, ___uri, ___local)));
