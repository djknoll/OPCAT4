...
public class ConsumptionSentenceTypeImpl implements extensionTools.opl2.generated.ConsumptionSentenceType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{

    protected java.lang.String _ProcessName;
    protected com.sun.xml.bind.util.ListImpl _ConsumptionClause = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
    ...
    {
        int idx2 = 0;
        final int len2 = _ConsumptionClause.size();
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            if (_ConsumptionClause.get(idx2) instanceof javax.xml.bind.Element) {
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ConsumptionClause.get(idx2 ++)));
            } else {
                context.startElement("", "ConsumptionClause");
                int idx_3 = idx2;
                context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _ConsumptionClause.get(idx_3 ++)));
                context.endAttributes();
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ConsumptionClause.get(idx2 ++)));
                context.endElement();
            }
            ...
            switch (state) {
                ...
                case  8 :
                    if (("" == ___uri)&&("MinimalCardinality" == ___local)) {
                        _ConsumptionClause.add(((extensionTools.opl2.generated.impl.ConsumptionClauseTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ConsumptionClauseTypeImpl.class), 9, ___uri, ___local, __atts)));
                        return ;
                    }
                    break;
                case  0 :
            ...
            switch (state) {
                ...
                case  8 :
                    if (("" == ___uri)&&("subjectExhibitionFatherRole" == ___local)) {
                        _ConsumptionClause.add(((extensionTools.opl2.generated.impl.ConsumptionClauseTypeImpl) spawnChildFromEnterAttribute((extensionTools.opl2.generated.impl.ConsumptionClauseTypeImpl.class), 9, ___uri, ___local)));
                        return ;
                    }
