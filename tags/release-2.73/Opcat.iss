...
[Setup]
AppName=Opcat 2.73
AppVerName=Opcat version 2.73
AppCopyright=Copyright © 1999-2005 Opcat, Inc.

OutputBaseFilename =opcat_2-73_setup
...
[Files]
Source: Opcat2.jar; DestDir: {app}; CopyMode: alwaysoverwrite
...
Source: Opcat2.exe; DestDir: {app}; CopyMode: alwaysoverwrite
Source: license.lic; DestDir: {app}
Source: conf.txt; DestDir: {app}; CopyMode: alwaysoverwrite
Source: error.log; DestDir: {app}; CopyMode: alwaysoverwrite
...
[Run]
Filename: {app}\Opcat2.exe; Description: Launch Opcat; Flags: shellexec postinstall skipifsilent
...
[INI]
Filename: {app}\objectprocess.url; Section: InternetShortcut; Key: URL; String: http://www.objectprocess.org/
