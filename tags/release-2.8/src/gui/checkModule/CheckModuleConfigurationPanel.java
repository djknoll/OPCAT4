...
//	JTabbedPane relationsTabbedPane = new JTabbedPane(JTabbedPane.LEFT);
	...
	{
		mainTabbedPane.addTab("Agent Link", OPMImages.AGENT_LINK, new ConfigurationPanel());		
		//mainTabbedPane.addTab("Exeption Link", new ImageIcon(Opcat2.javaImagesPath + "exceptionLink.gif"),new ConfigurationPanel());
		mainTabbedPane.addTab("Exeption Link", OPMImages.EXCEPTION_LINK ,new ConfigurationPanel());
