...
public class GridPanel extends JPanel{
	...
	public GridPanel(int ColumnsNumber , Vector ColumnsNames) {
		...
		resizeButton.setToolTipText("Press to Resize Columns");		
		
		JButton clearButton = new JButton();
		clearButton.setSize(resizeButton.getSize()); 
		clearButton.setText("Clear");
		
		JButton closeButton = new JButton();
		closeButton.setMinimumSize(resizeButton.getSize());
		...
		resizeButton.addActionListener(new ResizeButton(this)) ; 
	...
	class ResizeButton implements java.awt.event.ActionListener { 
		private GridPanel panel ; 
		public ResizeButton( GridPanel pane ) {
			panel = pane ; 
		}
		public void actionPerformed(ActionEvent e) { 
			panel.ResizeColumns(); 
