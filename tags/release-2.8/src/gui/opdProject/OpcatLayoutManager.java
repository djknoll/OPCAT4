...
public class OpcatLayoutManager{
  ...
  public void align2Left(){
    alignDirections(Constraint.directionVertical, Constraint.originStart);
  }

  public void align2CenterVertically(){
    alignDirections(Constraint.directionVertical, Constraint.originCenter);
  }

  public void align2Right(){
    alignDirections(Constraint.directionVertical, Constraint.originEnd);
  }

  public void align2Top(){
    alignDirections(Constraint.directionHorizontal, Constraint.originStart);
  }

  public void align2CenterHorizontally(){
    alignDirections(Constraint.directionHorizontal, Constraint.originCenter);
  }

  public void align2Bottom(){
    alignDirections(Constraint.directionHorizontal, Constraint.originEnd);
  }
