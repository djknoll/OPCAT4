...
public class DeletionChecker extends ConsistencyAbstractChecker implements ConsistencyCheckerInterface{
	...
	public void check() {	
		...
		ConsistencyAbstractChecker checker = new InzoomedDeletion (getMyOptions(), getResults()) ;
		checker.check() ; 	
	...
	public void deploy(ConsistencyResult checkResult) {
		...
		for (int i = 0 ; i < checkers.size(); i++) {
			ConsistencyAbstractChecker checker = (ConsistencyAbstractChecker) checkers.get(i) ; 
			if(checker.isDeploy()) {
