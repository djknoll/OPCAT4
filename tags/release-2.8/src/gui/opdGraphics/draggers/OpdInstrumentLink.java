...
public class OpdInstrumentLink extends OpdLink
{
	...
	public void  paintComponent(Graphics g)
	{
		...
		DoublePoint center = new DoublePoint( getWidth()/2, (getHeight()-size+1.0)/2 );
	 ...
	 */
		...
		{
		  LinkPropertiesDialog ld = new LinkPropertiesDialog(myLink, new OpdKey(getOpdId(), getEntityInOpdId()), myProject, "Instrument");
		  ld.show();
		}
