...
public class DirectionPanel extends JPanel {
    ...
    ImageIcon bl_dot   = loadImageIcon(DirectionButtonsImages.BL,"bottom left layout button");
    ImageIcon bldn_dot = loadImageIcon(DirectionButtonsImages.BLDN,"selected bottom left layout button");
    ImageIcon bm_dot   = loadImageIcon(DirectionButtonsImages.BM,"bottom middle layout button");
    ImageIcon bmdn_dot = loadImageIcon(DirectionButtonsImages.BMDN,"selected bottom middle layout button");
    ImageIcon br_dot   = loadImageIcon(DirectionButtonsImages.BR,"bottom right layout button");
    ImageIcon brdn_dot = loadImageIcon(DirectionButtonsImages.BRDN,"selected bottom right layout button");
    ImageIcon c_dot    = loadImageIcon(DirectionButtonsImages.C,"center layout button");
    ImageIcon cdn_dot  = loadImageIcon(DirectionButtonsImages.CDN,"selected center layout button");
    ImageIcon ml_dot   = loadImageIcon(DirectionButtonsImages.ML,"middle left layout button");
    ImageIcon mldn_dot = loadImageIcon(DirectionButtonsImages.MLDN,"selected middle left layout button");
    ImageIcon mr_dot   = loadImageIcon(DirectionButtonsImages.MR,"middle right layout button");
    ImageIcon mrdn_dot = loadImageIcon(DirectionButtonsImages.MRDN,"selected middle right layout button");
    ImageIcon tl_dot   = loadImageIcon(DirectionButtonsImages.TL,"top left layout button");
    ImageIcon tldn_dot = loadImageIcon(DirectionButtonsImages.TLDN,"selected top left layout button");
    ImageIcon tm_dot   = loadImageIcon(DirectionButtonsImages.TM,"top middle layout button");
    ImageIcon tmdn_dot = loadImageIcon(DirectionButtonsImages.TMDN,"selected top middle layout button");
    ImageIcon tr_dot   = loadImageIcon(DirectionButtonsImages.TR,"top right layout button");
    ImageIcon trdn_dot = loadImageIcon(DirectionButtonsImages.TRDN,"selected top right layout button");    	
