...
public class NodeNodeOverlapConstraint extends TwoNodeConstraint
{
    ...
    public String toString()
    {
        return MessageFormat.format( "[Node-node overlapping for {0} and {1}]",
                                     new Object[] {m_nodeConnection1.m_node, m_nodeConnection2.m_node});
    }
    ...
    public LinkedList Attach()
    {
        ...
        if (null == m_springs)
        {
            ...
            double springRestLength = (m_nodeConnection1.m_node.GetRadius() + m_nodeConnection2.m_node.GetRadius());
            Spring spring = new NodeNodeSpring(this, springRestLength, m_nodeConnection1, m_nodeConnection2);
    ...
    {
        return m_nodeConnection1.m_node.Overlaps(m_nodeConnection2.m_node) ? super.GetSpringConstant(spring) : 0;
    }
}
