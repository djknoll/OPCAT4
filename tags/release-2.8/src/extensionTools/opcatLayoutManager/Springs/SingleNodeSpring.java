...
public abstract class SingleNodeSpring extends Spring
{
                                ...
                                SpringConnectionPoint nodeConnection)
    {
        ...
        m_nodeConnection = nodeConnection;
    }
    ...
    {
        m_nodeConnection.m_node.RemoveSpring(this);
    }
    ...
    {
        if (null != node && !node.equals(m_nodeConnection.m_node))
        {
            
            return new Vector2D();
        }

        if (!m_nodeConnection.m_applyForce)
        {
            return new Vector2D();
        }
        ...
        Debug.Print( 25,
                     ...
                     new Object[] {m_nodeConnection.m_node, m_constraint});
    ...
    {
        return m_nodeConnection.m_node;
    }
