 ...
 */
  ...
  */
 public int getDestinationRange(){ return destinationRange;}

 /**
  * the fanction setDestinationRange
  * @param range the range to set
  */
  public void setDestinationRange(int range){ destinationRange = range;}

  /**
   * the fanction getSourceRange
   * @return the range
   */
  public int getSourceRange(){ return sourceRange;}

  /**
   * the fanction setSourceRange sets the range
   * @param range the range to set
   */
  public void setSourceRange(int range){ sourceRange = range;}
