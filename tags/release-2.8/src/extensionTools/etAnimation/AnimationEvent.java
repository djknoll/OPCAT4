...
/*
  AnimationEvent class is a storage of various properties relevant
...
class AnimationEvent {
  ...
  private AnimationEntry parentProcess = null;
  ...
  private AnimationEntry aEventLink = null;  // event link that activated the process
 ...
 // if this indicator is true the system will try to activate the event until it will succeed
  ...
  public AnimationEvent(long step, String path, long duration, int numberOfInstances, long schedulingStep)  {
    this.step = step;
    this.path = path;
  ...
  public AnimationEvent(AnimationEvent aEvent)  {
  ...
  public void setParentProcess(AnimationEntry parentProcess) {
    this.parentProcess = parentProcess;
  }

  public AnimationEntry getParentProcess() {
    return this.parentProcess;
  }

  public void setEventType(int type) {
    if (type == AnimationSettings.ACTIVATION_EVENT) {
      this.eventType = AnimationSettings.ACTIVATION_EVENT;
    }
    else  {
      this.eventType = AnimationSettings.TERMINATION_EVENT;
    }
  }
  ...
  public void setExecutionId() {
    this.executionId = ++AnimationSettings.LAST_EXECUTION_ID;
  }
  ...
  public void setEventLink(AnimationEntry aEventLink) {
    this.aEventLink = aEventLink;
  }

  public AnimationEntry getEventLink() {
