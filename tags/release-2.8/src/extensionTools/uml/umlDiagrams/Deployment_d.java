 ...
 */
    public void DeploymentDiagramCreate(ISystem sys, FileOutputStream file,Vector deplPrVec,Vector deplRelVec) throws IOException{
    try{

      String temp;
      ISystemStructure MyStructure;
      Enumeration e,linkS,linkD,relS,relD;
