...
public class ProcessAggregationSentenceTypeImpl implements extensionTools.opl2.generated.ProcessAggregationSentenceType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{
    ...
    {
        int idx2 = 0;
        final int len2 = _AggregatedProcess.size();
        int idx3 = 0;
        ...
        while (idx2 != len2) {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) _AggregatedProcess.get(idx2 ++)));
            } catch (java.lang.Exception e) {
                com.sun.xml.bind.marshaller.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
            ...
            throws com.sun.xml.bind.unmarshaller.UnreportedException
        {
            switch (state) {
                ...
                case  3 :
                    ...
                    if (("" == ___uri)&&("AggregatedProcess" == ___local)) {
                        context.pushAttributes(__atts);
                        state = 6;
                        return ;
                    }
