            ...
            switch (state) {
                case  1 :
                    if (("" == ___uri)&&("OperationName" == ___local)) {
                        spawnSuperClassFromEnterElement((((extensionTools.opl2.generated.impl.OperationTypeImpl)extensionTools.opl2.generated.impl.OperationImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, __atts);
                        return ;
                    }
                    break;
                case  3 :
