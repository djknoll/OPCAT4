...
public class ProcessInheritanceSentenceSetTypeImpl implements extensionTools.opl2.generated.ProcessInheritanceSentenceSetType, com.sun.xml.bind.unmarshaller.UnmarshallableObject, com.sun.xml.bind.serializer.XMLSerializable, com.sun.xml.bind.validator.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _ProcessInheritanceSentence = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
    ...
    public java.util.List getProcessInheritanceSentence() {
        return _ProcessInheritanceSentence;
    }
    ...
    {
        int idx1 = 0;
        final int len1 = _ProcessInheritanceSentence.size();
        int idx2 = 0;
        ...
        while (idx1 != len1) {
            if (_ProcessInheritanceSentence.get(idx1) instanceof javax.xml.bind.Element) {
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ProcessInheritanceSentence.get(idx1 ++)));
            } else {
                context.startElement("", "ProcessInheritanceSentence");
                int idx_2 = idx1;
                context.childAsAttributes(((com.sun.xml.bind.serializer.XMLSerializable) _ProcessInheritanceSentence.get(idx_2 ++)));
                context.endAttributes();
                context.childAsElements(((com.sun.xml.bind.serializer.XMLSerializable) _ProcessInheritanceSentence.get(idx1 ++)));
                context.endElement();
            }
            ...
            throws com.sun.xml.bind.unmarshaller.UnreportedException
        {
            switch (state) {
                case  3 :
                    ...
                    if (("" == ___uri)&&("ProcessInheritanceSentence" == ___local)) {
                        context.pushAttributes(__atts);
                        state = 4;
                        return ;
                    }
                ...
                case  4 :
                    if (("" == ___uri)&&("InheritanceFatherName" == ___local)) {
                        _ProcessInheritanceSentence.add(((extensionTools.opl2.generated.impl.ProcessInheritanceSentenceTypeImpl) spawnChildFromEnterElement((extensionTools.opl2.generated.impl.ProcessInheritanceSentenceTypeImpl.class), 5, ___uri, ___local, __atts)));
                        return ;
                    }
                    break;
                case  0 :
