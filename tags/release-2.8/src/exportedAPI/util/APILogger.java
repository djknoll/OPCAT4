...
public class APILogger {
	...
	/**
	 * Logs a Message to the Debug Pane on the extension tools tab. The Debug tab will 
	 * be shown only if @see SetDebug is used to turn on Debug pane. 
	 * This pane is turned off in production versions.
	 * @param obj the Object source of the Message
	 * @param Message the Message to print into the debug window.   
	 */
	public static void Print(Object obj, String Message) {
		Debug debug = Debug.getInstance() ; 
		debug.Print( obj, Message, "ExtensionTools") ; 
	}
	
	/**
	 * Used to turn Debug mode On @see Print
	 *
	 */
