...
public class TestingSettingsWindow extends JDialog {
	...
	private void jbInit() throws Exception {
		...
		this.jRadioButtonTakeFromLowLevelProcessesMinTime.setText("Process min time");		
		...
		this.jLabel5
				.setToolTipText("show/hide the life-span graph");
		...
		this.buttonGroupProcessDuration.add(this.jRadioButtonTakeFromLowLevelProcessesMinTime) ; 
		...
		this.jPanelFields.add(this.jRadioButtonTakeFromLowLevelProcessesMinTime,
