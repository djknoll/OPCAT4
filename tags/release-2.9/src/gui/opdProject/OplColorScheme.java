...
//  private TreeMap attributes;
  private ColorAttribute[] attributes = new ColorAttribute[this.OPLColors+this.TeamColors];
...
//  }
  ...
  public void getSchemeFrom(OplColorScheme origin) {
    ...
    this.setTextSize(OplColorScheme.getTextSize());
  }

  public void setDefault() {
    this.putAttribute(DEFAULT_STYLE,
                 new ColorAttribute("Reserved Words", Color.black, false, false, false));
    this.putAttribute(OplColorScheme.OBJECT_STYLE,
                 new ColorAttribute("Objects", new Color(0, 109, 0), false, false, false));
    this.putAttribute(PROCESS_STYLE,
...
//        putAttribute(General.STATE_STYLE, new ColorAttribute("States", new Color(125,0,125), false, false, false));
    this.putAttribute(STATE_STYLE,
                 new ColorAttribute("States", new Color(91, 91, 0), false, false, false));
    this.putAttribute(CARDINALITY_STYLE,
                 new ColorAttribute("Cardinalities", Color.black, false, false, false));
    this.putAttribute(TAG_STYLE, new ColorAttribute("Tags", Color.black, false, false, false));
//OPCATeam
    Color greenColor = new Color(0,110,0);
    Color blueColor = new Color(0,102,255);
    this.putAttribute(NOTE_STYLE, new ColorAttribute("Notes", Color.red, false, false, false));
    this.putAttribute(PROMPT_STYLE, new ColorAttribute("Prompt", blueColor, false, false, false));
    this.putAttribute(MSG_STYLE, new ColorAttribute("Message", greenColor, false, false, false));
