...
*/
				...
				OpmGeneralRelation pRelation, OpdKey myKey, OpdProject project,Container container)
		{
		  ...
		  this.line = new StyledLine(source, this.sourceDragger,
								...
								this.myRelation, this.getKey(), this.myProject);
	  ...
	  private OpdRelationDragger createOpdRelation(Connectable edge, RelativeConnectionPoint pPoint)
	  {
		...
		{
			nRelation = new OpdUniDirectionalRelation(edge, pPoint, (OpmUniDirectionalRelation)this.myRelation , this.getKey().getOpdId(), this.getKey().getEntityInOpdId(), this.myProject);
		}

		if (this.myRelation instanceof OpmBiDirectionalRelation)
		{
			nRelation = new OpdBiDirectionalRelation(edge, pPoint, (OpmBiDirectionalRelation)this.myRelation , this.getKey().getOpdId(), this.getKey().getEntityInOpdId(), this.myProject);
		}
	...
	private TransparentRelationDragger createTransparentDragger(Connectable edge, RelativeConnectionPoint pPoint)
	{
		...
		gDragger = new TransparentRelationDragger(edge, pPoint, (OpmUniDirectionalRelation)this.myRelation , this.getKey().getOpdId(), this.getKey().getEntityInOpdId(), this.myProject);
...
*/
	public OpdRelationDragger getDestinationDragger()
	{
		...
		public void update()
		{
			...
			this.destinationDragger.setText(this.myRelation.getDestinationCardinality());
		...
		public void copyPropsFrom(GeneralRelationInstance origin)
		{
			...
			this.sourceDragger.getOpdCardinalityLabel().setLocation(this.sourceDragger.getX()+dX, this.sourceDragger.getY()+dY);
			...
			this.destinationDragger.getOpdCardinalityLabel().setLocation(this.destinationDragger.getX()+dX, this.destinationDragger.getY()+dY);
		}
