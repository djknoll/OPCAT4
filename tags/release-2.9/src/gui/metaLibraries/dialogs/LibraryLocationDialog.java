...
public class LibraryLocationDialog extends JDialog {
	...
	private void jbInit() throws Exception {
		...
		this.chooseFile
				.setToolTipText("The imported library is located in the local file system");
		if (this.libraryResourceType == MetaLibrary.TYPE_FILE) {
			this.changeToFile();
		} else {
			this.changeToURL();
		}
	...
	private void changeToFile() {
		...
		this.libraryResourceType = MetaLibrary.TYPE_FILE;
	}
	...
	private void changeToURL() {
		if (this.libraryResourceType != MetaLibrary.TYPE_URL) {
		...
		this.broswButton.repaint();
		this.libraryResourceType = MetaLibrary.TYPE_URL;
	}
	...
	void broswButton_actionPerformed(ActionEvent e) {
		...
		String[] csv = { "csv", "txt" };
		CustomFileFilter myFilter = new CustomFileFilter(csv, "MetaData Files");
		if (Features.hasReq()) {
