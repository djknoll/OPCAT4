...
public class Saver {
	...
	public void save(OpdProject project, JProgressBar progressBar, JFrame parent) {
		...
		File backupFile = new File(FileControl.getInstance().getOPCATBackupDirectory() + FileControl.fileSeparator + newFile.getName() + ".bak");
		try {
			...
			String msg = "Saving error occured on file "+ fileName +" on saver version "+ this.usedVersion +"\n Error text: "+ sex.getMessage();
	...
	private void showErrorMessage()	{
		...
		JOptionPane.showMessageDialog(this.parentFrame, errorMessage, "Saving Error", JOptionPane.ERROR_MESSAGE);
	}
