...
public class LoaderVer2 implements LoaderI {
    ...
    /*
         * TODO: there is no need to pass the graphic objects like the desktop
         * to the load function. the file funcctions shoud fucos on file ops
         * only and not set any graphics objects. raanan
         */
	...
	if (destinationInstance == null) {
	    ...
	    OpcatLogger.logError("Opd " + sourceInstance.getOpd().getName()
		    + ", ID - " + sourceInstance.getOpd().getOpdId());
	    OpcatLogger.logError("Source Instance Key"
		    + sourceInstance.getKey());
	    OpcatLogger.logError("XML - " + xmlRelation.getText());
