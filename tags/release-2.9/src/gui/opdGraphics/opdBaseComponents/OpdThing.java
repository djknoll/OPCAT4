...
public abstract class OpdThing extends OpdConnectionEdge implements
    ...
    public boolean contains(int x, int y) {
        if ((x >= 0) && (x < this.getActualWidth()) && (y >= 0) && (y < this.getActualHeight())) {
            return true;
        } else {
            return false;
        }
    ...
    public void setShadow(boolean shadowed) {
        ...
        if (this.shadow && !shadowed) {
            this.setSize(this.getWidth() - shadowOffset, this.getHeight() - shadowOffset);
    ...
    public void showPopupMenu(int pX, int pY) {
        JPopupMenu jpm = new ThingPopup(this.myProject, this.getInstance(), pX, pY);
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (((ThingInstance) (this.getEntry().getInstance(this.getOpdKey())))
                .isZoomedIn()
                && ((StateMachine.getCurrentState() == StateMachine.USUAL_SELECT) || (StateMachine.getCurrentState() == StateMachine.EDIT_CUT))) {
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        if (this.myProject.getCurrentOpd().isOpenReused()) {
            Point pElm = this.getLocation();
            int OpdHeight = this.myProject.getCurrentOpd().getDrawingArea()
                    .getHeight() / 2;
        ...
        if (!((ThingInstance) (this.getEntry().getInstance(this.getOpdKey())))
            ...
            if (this.myProject.getEnableDragging()) {
                this.draggedTInstance = (ThingInstance) (this.getEntry()
                        .getInstance(this.getOpdKey()));
                this.targetInstance = this.myProject
                        .returnThingIntersection(this.draggedTInstance);
                if (this.targetInstance != null) {
                    if (this.draggedTInstance.getTargetThingInstance() == null) {
                        this.draggedTInstance
                                .setTargetThingInstance((ThingInstance) this.targetInstance);
                        this.draggedTInstance
                                .setTargetBackgroundColor(this.targetInstance
                                        .getBackgroundColor());
                        this.targetInstance.setBackgroundColor(new Color(255, 0, 0));
                        this.targetInstance.update();
                    }
                } else {
                    if (this.draggedTInstance.getTargetThingInstance() != null) {
                        this.draggedTInstance.getTargetThingInstance()
                                .setBackgroundColor(this.draggedTInstance
                                        .getTargetBackgroundColor());
                        this.draggedTInstance.getTargetThingInstance().update();
                        this.draggedTInstance.setTargetBackgroundColor(null);
                        this.draggedTInstance.setTargetThingInstance(null);
                    }
                }
            }
            //End merge action
            ...
            if (((ThingInstance) (this.getEntry().getInstance(this.getOpdKey())))
                ...
                Point eventPoint = SwingUtilities
                        .convertPoint(this, e.getX(), e.getY(), this.myProject
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (StateMachine.getCurrentState() != StateMachine.IN_SELECTION) {
            ...
            /****************Commiting Merge*********** */
            targetInstance = this.myProject
                    .returnThingIntersection((ThingInstance) (this.getEntry()
                            .getInstance(this.getOpdKey())));
            if (targetInstance != null) {
                if (!((targetInstance.getEntry().isLocked()) || this.getEntry()
                        .isLocked())) {
                    MergeCommand command = new MergeCommand(this.myProject);
                    
                    try {
                        command.commitMerge((ThingInstance) (this
                                .getEntry().getInstance(this.getOpdKey())), (ThingInstance) targetInstance, true);
    ...
    public ThingEntry getMyEntry() {
        return (ThingEntry) this.myEntry;
    }
    //endReuseComment
