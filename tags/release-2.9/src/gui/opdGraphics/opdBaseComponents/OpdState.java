...
public class OpdState extends OpdConnectionEdge {
    ...
    /**
         * <p>
         * Constructs <code>OpdState</code> object and initialize all
         * defaults.
         * </p>
         ...
         *                is added to.
         * @param <code>mState OpmState</code>, the logic representation of
         *                the state <a href = "../opmEntities/OpmState.html"><code>OpmState</code></a>.
         * @param <code>fNode DefaultMutableTreeNode</code>, the reference
         *                to the parent node in <a href =
    ...
    /**
         * @return the string repersentation of State, actually returns Entity
         *         name.
         */
    ...
    /**
         ...
         * "StatePropertiesDialog.html"><code>StatePropertiesDialog</code></a>
         * <p>
         * Updates changed State properties not only in this OpdState, but in <a
         * href = "../opmEntities/OpmState.html"><code>OpmState</code></a>
         * this <code>OpdState</code> represents.
         */
    ...
    /**
         * The method implicitly define the cursor type when hovering over a
         * state. It's a walk around the draw problem.
         * 
         * @author Eran Toch
         */
